...
if not exist "%SRC_DIR%\AIBuildObject.cpp" (
    echo ERROR: missing required source "%SRC_DIR%\AIBuildObject.cpp"
    popd
    exit /b 1
)
...
if "%NEED_LINK%"=="1" (
    echo [3/3] Linking...
     link /nologo /DEBUG /INCREMENTAL /STACK:4194304 /OUT:"%OUT_EXE%" ^
