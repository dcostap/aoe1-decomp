...
cl /EHsc /std:c++17 /MDd /D_DEBUG ^
  /I"%DP_INC%" ^
  /Fo"build\\" ^
  src\game\main.cpp src\game\tribegam.cpp src\game\basegame.cpp src\game\globals.cpp src\game\Res_file.cpp src\game\sceninfo.cpp src\game\gameinfo.cpp src\game\file_stf.cpp src\game\getdxver.cpp ^
