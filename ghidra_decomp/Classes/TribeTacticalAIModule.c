...
// [0x0F4] ManagedArray<int> civilians (sz: 0x10)
// [0x104] ManagedArray<int> civilianExplorers (sz: 0x10)
// [0x114] ManagedArray<int> soldiers (sz: 0x10)
// [0x124] ManagedArray<int> ungroupedSoldiers (sz: 0x10)
// [0x134] ManagedArray<int> boats (sz: 0x10)
// [0x144] ManagedArray<int> warBoats (sz: 0x10)
// [0x154] ManagedArray<int> fishingBoats (sz: 0x10)
// [0x164] ManagedArray<int> tradeBoats (sz: 0x10)
// [0x174] ManagedArray<int> transportBoats (sz: 0x10)
// [0x184] ManagedArray<int> artifacts (sz: 0x10)
// [0x194] int[226] sn (sz: 0x388)
// [0x51C] UnitData[50] gatherers (sz: 0x4B0)
// [0x9CC] int numberGatherersValue
// [0x9D0] int desiredNumberGatherersValue
// [0x9D4] TacticalAIGroup groups (sz: 0x330)
// [0xD04] int groupIDValue
// [0xD08] int numberGroupsValue
// [0xD0C] ulong lastGroupAttackTime
// [0xD10] ulong lastGroupRebalanceTime
// [0xD14] ulong lastAttackResponseTime
// [0xD18] ulong lastBoatAttackResponseTime
// [0xD1C] ulong lastScalingUpdateValue
// [0xD20] int numberBuildUpdatesSkipped
// [0xD24] int randomizedAttackSeparationTime
// [0xD28] ManagedArray<int> playersToAttack (sz: 0x10)
// [0xD38] ManagedArray<int> playersToDefend (sz: 0x10)
// [0xD48] ManagedArray<int> workingArea (sz: 0x10)
// [0xD58] ManagedArray<int> unitsTaskedThisUpdate (sz: 0x10)
// [0xD68] int[4] actualGathererDistribution (sz: 0x10)
// [0xD78] int[4] desiredGathererDistribution (sz: 0x10)
// [0xD88] int[4] neededResourceValue (sz: 0x10)
// [0xD98] int[4] resourceDifferenceValue (sz: 0x10)
// [0xDA8] ResourceItem neededResources (sz: 0x70)
// [0xE18] int attackEnabledValue
// [0xE1C] int updateArea
// [0xE20] int firstNeededResourceUpdateDone
// [0xE24] int[4] numberStoragePitsBuilt (sz: 0x10)
// [0xE34] int[4] numberGranariesBuilt (sz: 0x10)
// [0xE44] int wonderInProgressValue
// [0xE48] int wonderBuiltValue
// [0xE4C] PlacementState placementStateValue (sz: 0x130)
// [0xF7C] int nextCivilianToTaskValue
// [0xF80] int nextIdleSoldierGroupToTaskValue
// [0xF84] int nextActiveSoldierGroupToTaskValue
// [0xF88] int builtFirstStoragePit
// [0xF8C] int builtFirstGranary
// [0xF90] ulong lastBuildTime
// [0xF94] ulong lastAttackResponseBuildInsertionTime
// [0xF98] ulong lastCoopTributeDemandTime
// [0xF9C] ulong lastCoopTributeGiftTime
// [0xFA0] ulong lastCoopAttackDemandTime
// [0xFA4] int zoomingToNextAge
// [0xFA8] ulong lastUngroupedSoldierTaskTime
// [0xFAC] AttackState attackStateValue (sz: 0x2C)
// [0xFD8] int[9] hitsByPlayer (sz: 0x24)
// [0xFFC] int lastUpdateAreaTimeValue
// [0x1000] int averageUpdateAreaTimeValue
// [0x1004] int updateAreaAverageCount
// [0x1008] int updateAreaAverageTotal
// ----------------------------------------------------------------
