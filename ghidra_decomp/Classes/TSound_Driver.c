...
// [0x001] uchar mute
// [0x004] void * main_wnd
// [0x008] IDirectSound * direct_sound
// [0x00C] IDirectSoundBuffer * primary_buffer
// [0x010] long dsrval
// [0x014] long start_volume
// [0x018] long volume
// [0x01C] char[260] path (sz: 0x104)
// [0x120] int mixer_open
// [0x124] void * mixer_handle
// [0x128] tagMIXERLINEA mixer_line_info (sz: 0xA8)
// [0x1D0] tagMIXERLINECONTROLSA mixer_line_controls (sz: 0x18)
// [0x1E8] tagMIXERCONTROLA mixer_volume_control (sz: 0x94)
// [0x27C] tMIXERCONTROLDETAILS mixer_volume_details (sz: 0x18)
// [0x294] tMIXERCONTROLDETAILS_UNSIGNED mixer_volume_value
// [0x298] TDigital *[256] sound_play_list (sz: 0x400)
// [0x698] int play_list_count
// ----------------------------------------------------------------
