...
// [0x034] long map_type
// [0x038] long number_of_players
// [0x03C] RGE_Land_Info land_info (sz: 0x1438)
// [0x1474] RGE_Terrain_Info terrain_info (sz: 0x1298)
// [0x270C] RGE_Object_Info object_info (sz: 0x18C8)
// [0x3FD4] RGE_Elevation_Info elevation_info (sz: 0xF80)
// [0x4F54] RGE_Map_Data map_info (sz: 0x8)
// ----------------------------------------------------------------
          ...
          RGE_Land_Data_Entry *param_4)
{
  ...
  if (param_3 < 4) {
    ...
    fVar2 = fVar2 * _DAT_00571ea8;
    goto LAB_0048366e;
  }
  fVar2 = fVar2 * _DAT_00571eac;
LAB_0048366e:
  mid_x2 = __ftol();
  local_28 = __ftol();
  mid_y1 = __ftol();
