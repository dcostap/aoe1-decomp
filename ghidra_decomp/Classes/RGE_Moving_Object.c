...
//
// Member Layout:
// [0x08C] float trail_remainder
// [0x090] float velocity_x
// [0x094] float velocity_y
// [0x098] float velocity_z
// [0x09C] float angle
// [0x0A0] float turn_towards_time
// [0x0A4] Path pathValue (sz: 0x34)
// [0x0D8] Path exceptionPathValue (sz: 0x34)
// [0x10C] Waypoint startValue (sz: 0x10)
// [0x11C] Waypoint goalValue (sz: 0x10)
// [0x12C] float turnTimer
// [0x130] float collisionAvoidanceDistance
// [0x134] float actionRange
// [0x138] int targetIDValue
// [0x13C] float targetRadiusX
// [0x140] float targetRadiusY
// [0x144] int continueCounter
// [0x148] int rangeStatusValue
// [0x14C] int currentTerrainException1
// [0x150] int currentTerrainException2
// [0x154] uchar storePathInExceptionPath
// [0x155] uchar waitingToMoveValue
// [0x156] uchar numberWaitDelays
// [0x158] XYPoint minInitialPointValue (sz: 0x8)
// [0x160] XYPoint maxInitialPointValue (sz: 0x8)
// [0x168] XYZBYTEPoint * userDefinedWaypoints
// [0x16C] int numberUserDefinedWaypointsValue
// [0x170] int maxUserDefinedWaypointsValue
// [0x174] uchar finalUserDefinedWaypoint
// [0x178] float closestDistanceToWaypoint
// [0x17C] uchar lastFacet
// [0x17D] uchar lastFacet2
// ----------------------------------------------------------------
