...
public:
    ...
    virtual  ~TVerticalSliderPanel() noexcept(false); // Ghidra: `scalar_deleting_destructor'
...
public:
    ...
    // [Slot 00] Offset 0x00 (Override)
    virtual  ~THorizontalSliderPanel() noexcept(false); // Ghidra: `scalar_deleting_destructor'
