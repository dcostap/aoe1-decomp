...
public:
    ...
    virtual  ~TribeMPSetupScreen() noexcept(false); // Ghidra: `vector_deleting_destructor'
...
public:
    ...
    // [Slot 00] Offset 0x00 (Override)
    virtual  ~TRIBE_Screen_Wait() noexcept(false); // Ghidra: `scalar_deleting_destructor'
...
public:
    ...
    // [Slot 00] Offset 0x00 (Override)
    virtual  ~TRIBE_Screen_Disconnect() noexcept(false); // Ghidra: `vector_deleting_destructor'
