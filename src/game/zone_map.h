...
public:
    ...
    virtual ~RGE_Zone_Map();
    virtual void save(int param_1);
    virtual uchar do_zone_map();
    virtual void do_zone_map_area(long param_1, long param_2, uchar param_3, uchar param_4);
    virtual RGE_Zone_Map* check_info(float* param_1, long param_2);
    virtual uchar get_zone_info(long param_1, long param_2);
    virtual int withinRange(XYPoint param_1, XYPoint param_2, float param_3);
    virtual int withinRange(uchar param_1, XYPoint param_2, float param_3);
    virtual int numberTilesInZone(uchar param_1);
...
public:
    ...
    virtual ~RGE_Zone_Map_List();
    virtual void save(int param_1);
    virtual long create_zone_map(float* param_1, long param_2);
    virtual RGE_Zone_Map* get_zone_map(float* param_1, long param_2, int* param_3);
    virtual RGE_Zone_Map* get_zone_map(long param_1);
    virtual void delete_zone_maps();
};
