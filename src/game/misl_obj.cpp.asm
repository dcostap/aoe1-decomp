...
RGE_Missile_Object::RGE_Missile_Object(RGE_Master_Combat_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5, int param_6) {
    /* TODO: Stub */
...
int RGE_Missile_Object::setup(RGE_Master_Combat_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5) {
    /* TODO: Stub */
    ...
    //         0045a8fc     RET        0x8
    //                              *                                            THUNK FUNCTION                                             *
    //                              thunk void __thiscall rehook(RGE_Action_Object * this)
    //                                Thunked-Function: RGE_Action_Object::reho
    //              void              <VOID>         <RETURN>
...
RGE_Missile_Object::~RGE_Missile_Object() {
    /* TODO: Stub */
    //                              void __thiscall ~RGE_Missile_Object(RGE_Missile_Object * this)
    //              void              <VOID>         <RETURN>
    //              RGE_Missile_Ob    ECX:4 (auto)   this
    //                               ??1RGE_Missile_Object@@UAE@XZ                                XREF[1]:     `scalar_deleting_destructor':0045a
    //                               RGE_Missile_Object::~RGE_Missile_Object
    //         0045a7f0     JMP        RGE_Combat_Object::~RGE_Combat_Object
    //         0045a7f5     ??         90h
    //         0045a7f6     NOP
    //         0045a7f7     NOP
    //         0045a7f8     NOP
