...
public:
    ...
    virtual  ~TRIBE_Screen_Status_Message() noexcept(false); // Ghidra: `vector_deleting_destructor'
...
static_assert(offsetof(TRIBE_Screen_Status_Message, message) == 0x478, "TRIBE_Screen_Status_Message Offset Mismatch");
