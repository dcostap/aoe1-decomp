...
void EmotionalAIModule::setOverallState(int param_1) {
    ...
    //         0040cd60     addr       switchD_0040cbed::caseD_0
    //         0040cd64     addr       switchD_0040cbed::caseD_1
    //         0040cd68     addr       switchD_0040cbed::caseD_2
    //         0040cd6c     addr       switchD_0040cbed::caseD_3
    //         0040cd70     addr       switchD_0040cbed::caseD_4
    //         0040cd74     addr       switchD_0040cbed::caseD_5
    //         0040cd78     ??         90h
    //         0040cd79     ??         90h
    //         0040cd7a     ??         90h
    //         0040cd7b     ??         90h
...
int EmotionalAIModule::state(int param_1) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
    return 0;
}

int EmotionalAIModule::overallState() {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
    return 0;
}
