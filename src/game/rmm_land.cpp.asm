...
RGE_RMM_Land_Generator::RGE_RMM_Land_Generator(RGE_Map* param_1, RGE_Random_Map_Module* param_2, RGE_Land_Info* param_3) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
}

uchar RGE_RMM_Land_Generator::check_terrain_and_zone(uchar param_1, uchar param_2, long param_3, long param_4) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
    return 0;
}
