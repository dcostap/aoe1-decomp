...
public:
    ...
    virtual void draw();                                    // vt0[12]+0x30=0x4777C0
    virtual long handle_idle();                             // vt0[19]+0x4C=0x476F30
    virtual long key_down_action(long param_1, short param_2, int param_3, int param_4, int param_5); // vt0[43]+0xAC=0x477220
    virtual long char_action(long param_1, short param_2);  // vt0[44]+0xB0=0x476FA0
    virtual void set_focus(int param_1);                    // vt0[48]+0xC0=0x476EE0
    virtual void set_text(char** param_1, short param_2);   // vt0[56]+0xE0=0x477990
    virtual void set_text(char* param_1);                   // vt0[58]+0xE8=0x477910
    TInputPanel();
    ~TInputPanel();
