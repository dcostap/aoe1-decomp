...
public:
    ...
    virtual  ~RGE_Action_Object() noexcept(false); // Ghidra: `vector_deleting_destructor'
    ...
    // [Slot 126] Offset 0x1F8 (Override)
    virtual void work2(RGE_Static_Object* param_1, float param_2, float param_3, float param_4, uchar param_5); // Ghidra: work2

    // [Slot 127] Offset 0x1FC (Override)
    virtual void set_task(short param_1); // Ghidra: set_task

    // [Slot 128] Offset 0x200 (Override)
    virtual void setTaskByTaskID(int param_1); // Ghidra: setTaskByTaskID

    // [Slot 129] Offset 0x204 (Override)
    virtual void set_action(RGE_Action* param_1); // Ghidra: set_action

    // [Slot 130] Offset 0x208 (Override)
    virtual void set_only_action(RGE_Action* param_1); // Ghidra: set_only_action

    // [Slot 131] Offset 0x20C (Override)
    virtual void set_end_action(RGE_Action* param_1); // Ghidra: set_end_action

    // [Slot 132] Offset 0x210 (Override)
    virtual RGE_Task* getTask(RGE_Static_Object* param_1, float param_2, float param_3, float param_4); // Ghidra: getTask

    // [Slot 133] Offset 0x214 (Override)
    virtual int setup(RGE_Master_Action_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5); // Ghidra: setup

    // [Slot 134] Offset 0x218 (Override)
    virtual RGE_Action_List* create_action_list(); // Ghidra: create_action_list
