...
public:
    ...
    virtual  ~TRIBE_Screen_Main_Menu() noexcept(false); // Ghidra: `scalar_deleting_destructor'
...
public:
    ...
    // [Slot 00] Offset 0x00 (Override)
    virtual  ~TRIBE_Screen_Main_Error() noexcept(false); // Ghidra: `vector_deleting_destructor'
