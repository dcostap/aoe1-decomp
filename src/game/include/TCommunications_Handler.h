...
public:
    ...
    // BEGIN Task 222 decomp gap declarations (declarations retained; source-of-truth offsets listed)
    // Source of truth: com_hand.cpp.decomp @ 0x00425780
    char* WaitingOnNamedInfo(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00425800
    char* WaitingOnInfo(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x004258E0
    void StopIfSyncFail(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00425910
    void ShowSyncChatMsgs(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00425930
    void DropPacketsIntentionally(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00425960
    void SetStepMode(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00425970
    void SetSpeedControl(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00425A20
    void Step(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00426350
    void KillAnyMissingPlayers(void);
    // Source of truth: com_hand.cpp.decomp @ 0x00426D40
    int HasKicked(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00426D50
    long SendPlayerName(void);
    // Source of truth: com_hand.cpp.decomp @ 0x00426DC0
    void LogRXMsg(uint param_2, uint param_3, ulong param_4, uchar param_5, uchar param_6);
    // Source of truth: com_hand.cpp.decomp @ 0x00427390
    int TXPing(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x00427440
    int TXDebugPing(void);
    // Source of truth: com_hand.cpp.decomp @ 0x004274B0
    long FastSend(ulong param_2, void* param_3, ulong param_4, int param_5, int param_6);
    // Source of truth: com_hand.cpp.decomp @ 0x004282C0
    ...
    // Source of truth: com_hand.cpp.decomp @ 0x004286F0
    void SetPlayerStopTurn(uint param_2, ulong param_3);
    // Source of truth: com_hand.cpp.decomp @ 0x00428710
    void CheckPlayerStopTurn(ulong param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x004289A0
    int TEST(void);
    // Source of truth: com_hand.cpp.decomp @ 0x00429BD0
    ulong HiTurnAcknowledged(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042A060
    void ClearRXForPlayer(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042A130
    void ClearTXForPlayer(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042A160
    void ClearRXTXForPlayer(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042A180
    int StoreIncoming(uint param_2, char* param_3, uint param_4, ulong param_5, ulong param_6);
    // Source of truth: com_hand.cpp.decomp @ 0x0042A330
    ...
    // Source of truth: com_hand.cpp.decomp @ 0x0042A650
    int RXAcknowledgeStoredMessage(uint param_2, uint param_3);
    // Source of truth: com_hand.cpp.decomp @ 0x0042A6E0
    int PurgeAcknowledgedStoredMessages(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042AD10
    int TXResendReply(uint param_2, uint param_3);
    // Source of truth: com_hand.cpp.decomp @ 0x0042B0A0
    ...
    // Source of truth: com_hand.cpp.decomp @ 0x0042B860
    void DestroyMultiplayerGame(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042CA20
    void SetRandomSeed(int param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042CB20
    char* GetCommStateStr(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042CB30
    char* GetReadyPlayerStr(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042CC90
    int GetActivePlayerCount(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042CD10
    int IsPlayerComputer(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042CD50
    char* GetCommInfo(uchar param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D120
    void UpdatePlayerInformation(ulong param_2, char* param_3, char* param_4);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D180
    int LaunchLobbyGame(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D3B0
    int SetGameTitle(char* param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D3E0
    void SetMyPlayerName(char* param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D4A0
    long CreateDirectPlayConversation(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D580
    int OpenMultiplayerConnection(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D590
    int CreateMultiplayerGame(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042D960
    int AddSelfPlayer(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042DA50
    long InitJoinGame(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042DA80
    int JoinMultiplayerGame(_GUID* param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042DD70
    long GetMyMultiPlayerCaps(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042DEA0
    void SetApplicationGUID(_GUID param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042DEE0
    void SetServiceGUID(_GUID param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042DF10
    void SetSessionGUID(_GUID param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042E380
    ...
    // Source of truth: com_hand.cpp.decomp @ 0x0042E500
    ...
    // Source of truth: com_hand.cpp.decomp @ 0x0042E580
    int IsPlayerReady(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042E5B0
    int ComputerPlayerGameStart(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042E670
    long DPlayGetSessionDesc(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042E730
    long CommGetCaps(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042EB60
    int SetMyGameOptions(char* param_2, ulong param_3);
    // Source of truth: com_hand.cpp.decomp @ 0x0042EBF0
    void* GetMyGameOptions(ulong* param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042ECC0
    void SetHostPlayerNumber(uint param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042ECD0
    uint GetHostPlayerNumber(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042ECE0
    void DebugSessionInformation(DPSESSIONDESC2* param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042EF60
    void OutOfSync(int param_2, ulong param_3);
    // Source of truth: com_hand.cpp.decomp @ 0x0042EF80
    int SendZoneMessage(char* param_2, ulong param_3);
    // Source of truth: com_hand.cpp.decomp @ 0x0042F110
    void ForcePlayerEnumeration(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042F140
    void ForcePlayerDestroyAndCreate(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042F190
    void ForceNameChange(void);
    // Source of truth: com_hand.cpp.decomp @ 0x0042F230
    void SetSpeedV1(ulong param_2);
    // Source of truth: com_hand.cpp.decomp @ 0x0042F250
