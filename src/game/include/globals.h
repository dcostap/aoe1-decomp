...
extern VISIBLE_UNIT_REC* VisibleUnitList[5];
extern int VisibleUnitList_Size[5];
extern int DAT_0087d7cc;
extern int DAT_0087d7d0;
extern int DAT_0087d7d4;
extern int DAT_0087d7d8;
extern TRIGONOMETRY trig;
extern int ENABLE_COMPRESSION;
extern int rge_write_error;
extern int Map_Update_Suppresion;
extern int debug_random_on;
extern short visible_combats;
