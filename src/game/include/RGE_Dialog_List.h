...
public:
    ...
    virtual short get_list_id(); // vt[76] (0x130)
    virtual char* get_list_name(); // vt[77] (0x134)
    virtual int create_list(); // vt[78] (0x138)
    virtual short get_cur_id(); // vt[79] (0x13C)
...
static_assert(sizeof(RGE_Dialog_List) == 0x4BC, "Size mismatch");
