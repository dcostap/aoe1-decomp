...
public:
    ...
    TRIBE_Master_Combat_Object(FILE* param_1, RGE_Sprite** param_2, RGE_Sound** param_3, short param_4, int param_5);

    // Virtuals (best-effort)
    virtual ~TRIBE_Master_Combat_Object(); // vt[0] (0x0)
    ...
    unsigned char button_location;
    short orig_pierce_armor;
};
static_assert(sizeof(TRIBE_Master_Combat_Object) == 0x164, "Size mismatch");
