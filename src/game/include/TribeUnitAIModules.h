...
public:
    ...
    virtual void load(int param_1) override;
    virtual RGE_Player* owner() const override;
    virtual RGE_Static_Object* object() const override;
    ...
    virtual int order(int param_1, int param_2, int param_3, int param_4, float param_5, float param_6, float param_7, float param_8, int param_9, int param_10, int param_11) override;
    virtual int notify(int param_1, int param_2, int param_3, long param_4, long param_5, long param_6) override;
    virtual int notifyCommander(int param_1, int param_2, int param_3, long param_4, long param_5, long param_6) override;
    virtual int notifyCommander(NotifyEvent* param_1) override;
    virtual void search() override;
    virtual void logDebug(char* param_1) override;
    virtual int importantObject(int param_1) override;
    virtual int canConvert(int param_1) override;
    virtual int importantWhenDead(int param_1) override;
    virtual int retryableOrder(int param_1) override;
