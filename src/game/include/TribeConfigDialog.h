...
public:
    ...
    TribeConfigDialog(Mode mode, TScreenPanel* parent_screen);

    // Virtuals (best-effort)
    virtual ~TribeConfigDialog(); // vt[0] (0x0)
    ...
    TribeConfigDialog::Mode modeValue;
    TTextPanel* title;
...
static_assert(sizeof(TribeConfigDialog) == 0x564, "Size mismatch");
