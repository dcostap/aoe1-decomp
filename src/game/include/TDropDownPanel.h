...
public:
    ...
    TDropDownPanel::DropdownMode mode;
    short val_num;
    long val_wid;
    long val_hgt;
    long btn_wid;
    ...
    void setCurrentLineNumber(int line_num);
    void setCurrentLineId(int id);
    char* currentLine();
    void set_sorted(int sorted);
    int get_sorted();
    long get_line();
