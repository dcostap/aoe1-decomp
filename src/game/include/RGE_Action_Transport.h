...
public:
    ...
    // Non-virtuals (act_tran.cpp)
    int targetZone();

    // Virtuals (best-effort)
    virtual ~RGE_Action_Transport(); // vt[0] (0x0)
    ...
    virtual int next_to_drop_off_terrain(); // vt[24] (0x60)

};
static_assert(sizeof(RGE_Action_Transport) == 0x40, "Size mismatch");
