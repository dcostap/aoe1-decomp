#pragma once
#include "common.h"
#include "TVerticalSliderPanel.h"
...
public:
    ...
    virtual ~THorizontalSliderPanel(); // vt[0] (0x0)
    ...
    // Non-virtual overload used by TEasy_Panel::create_horz_slider.
...
static_assert(sizeof(THorizontalSliderPanel) == 0x1CC, "Size mismatch");
