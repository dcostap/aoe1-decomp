#pragma once
#include "common.h"
#include "RGE_Master_Moving_Object.h"
...
public:
    ...
    RGE_Master_Action_Object(FILE* param_1, RGE_Sprite** param_2, RGE_Sound** param_3, short param_4, int param_5);

    // Virtuals (best-effort)
    virtual ~RGE_Master_Action_Object(); // vt[0] (0x0)
