...
public:
    ...
    int text_set;
    int picture_set;
    unsigned long last_picture_time;
    unsigned long last_pause_time;
    TRIBE_Credits_Screen::ScreenMode mode;
...
static_assert(sizeof(TRIBE_Credits_Screen) == 0x8B8, "Size mismatch");
