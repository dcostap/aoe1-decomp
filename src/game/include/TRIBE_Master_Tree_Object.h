...
public:
    ...
    TRIBE_Master_Tree_Object(FILE* param_1, RGE_Sprite** param_2, RGE_Sound** param_3, short param_4, int param_5);

    // Virtuals (best-effort)
    virtual ~TRIBE_Master_Tree_Object(); // vt[0] (0x0)
...
static_assert(sizeof(TRIBE_Master_Tree_Object) == 0xB8, "Size mismatch");
