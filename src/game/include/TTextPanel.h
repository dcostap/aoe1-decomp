...
public:
    ...
    virtual void set_text(char** param_1, short param_2); // vt[56] (0xE0)
    ...
    long font_wid;
    long font_hgt;
    TTextPanel::Alignment vert_align;
    TTextPanel::Alignment horz_align;
    int word_wrap;
    TTextPanel::Style text_style;
    unsigned long text_color1;
    unsigned long text_color2;
    unsigned long highlightTextColor1;
    unsigned long highlightTextColor2;
...
static_assert(sizeof(TTextPanel) == 0x188, "Size mismatch");
