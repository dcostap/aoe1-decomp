...
public:
    ...
    TribeSendQuickMessageDialog(TScreenPanel* parent_screen, Mode mode);

    // Virtuals (best-effort)
    virtual ~TribeSendQuickMessageDialog(); // vt[0] (0x0)
    ...
    TribeSendQuickMessageDialog::Mode modeValue;
};
static_assert(sizeof(TribeSendQuickMessageDialog) == 0x49C, "Size mismatch");
