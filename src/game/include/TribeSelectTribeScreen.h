...
public:
    ...
    virtual ~TribeSelectTribeScreen(); // vt[0] (0x0)
...
protected:
    void fillTribeText(int tribe_id);
    char* tribeName(int tribe_id);
...
static_assert(sizeof(TribeSelectTribeScreen) == 0x4B8, "Size mismatch");
