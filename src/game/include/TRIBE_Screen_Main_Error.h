...
public:
    TRIBE_Screen_Main_Error(); // 0x0049F0D0

    // Virtuals (best-effort)
    virtual ~TRIBE_Screen_Main_Error(); // vt[0] (0x0)
    ...
    void set_text(char* param_1); // 0x0049F2B0
    void set_text(long param_1);  // 0x0049F2D0

    TTextPanel* message;
    TButtonPanel* cancel_button;
    TButtonPanel* close_button;
};
static_assert(sizeof(TRIBE_Screen_Main_Error) == 0x484, "Size mismatch");
