...
TRIBE_Master_Player::TRIBE_Master_Player(_iobuf* param_1) {
    /* TODO: Stub */
...
void TRIBE_Master_Player::load_object(_iobuf* param_1, uchar param_2, RGE_Sprite** param_3, RGE_Sound** param_4, short param_5) {
    /* TODO: Stub */
