...
public:
    ...
    virtual void handle_point_condition(RGE_Victory_Point_Entry* param_1); // vt0[0]+0x0=0x531F30
    virtual void handle_condition(RGE_Victory_Entry* param_1); // vt0[1]+0x4=0x531F90
    virtual char* condition_description(RGE_Victory_Entry* param_1); // vt0[2]+0x8=0x532CC0
    virtual void save(int param_1);                         // vt0[3]+0xC=0x531B70
