// Auto-generated scaffold unit: com_spd.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/com_spd.cpp
#include "../include/common.h"

// Offset: 0x00432620
undefined RGE_Communications_Speed(RGE_Communications_Speed* this_, TCommunications_Handler* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432780
void RGE_Communications_Speed(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004327C0
void SetPlayerTurnSpeed(RGE_Communications_Speed* this_, uint param_2, uchar param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432800
void SetActualLatency(RGE_Communications_Speed* this_, uint param_2, ulong param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432840
void SetFutureSpeedChange(RGE_Communications_Speed* this_, uint param_2, uint param_3, ulong param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432870
void EnableSpeedControl(RGE_Communications_Speed* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432880
uint GetBufferGranularity(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432890
ulong GetAdjustmentCount(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004328A0
uint GetBufferGranularityAdjusted(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004328C0
uint BufferFramesRemaining(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004328D0
uint WaitingOnAcknowledgement(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004328E0
void AdjustLocalSpeed(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432940
void ReloadBufferFrames(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432970
uint BufferTimeToUse(RGE_Communications_Speed* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432A70
void Skip(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432A90
uchar GetHighLatencyCenti(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432B00
ulong GetPlayerLatency(RGE_Communications_Speed* this_, uint param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432B20
char* GetLatencyInfo(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432BD0
char* GetSelfPlayerOptimalSpeedStr(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432C10
char* GetPlayerSpeedStatusStr(RGE_Communications_Speed* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432C70
char* GetMachineSpeedInfo(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432D20
uint GetRecommendedBufferFrames(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432D90
uint GetAvgFrameRate(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432DA0
uint GetRecommendedBufferGranularity(RGE_Communications_Speed* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432DE0
int AnalyzeGameSpeed(RGE_Communications_Speed* this_, uint* param_2, uint* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: int __thiscall RGE_Communications_Speed::AnalyzeGameSpeed(unsigned int *,unsigned int *,int)  *
    //                              *********************************************************************************************************
...
// Offset: 0x00432FB0
void SetV1(RGE_Communications_Speed* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432FD0
void SetV2(RGE_Communications_Speed* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
