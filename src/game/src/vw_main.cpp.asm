// Auto-generated scaffold unit: vw_main.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/vw_main.cpp
#include "../include/common.h"

// Offset: 0x0053DAB0
undefined RGE_Main_View(RGE_Main_View* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053DBA0
int do_auto_scroll(RGE_Main_View* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053DEB0
int handle_keys(RGE_Main_View* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_0053e8e9() {
    ...
    //                               FUN_0053e8e9
    //         0053e8e9     NOP
    //         0053e8ea     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_0053e888::switchdataD_0053e8ec                       XREF[1]:     mouse_left_move_action:0053e888(*)
}
...
// Offset: 0x0053FBD0
uchar pick1(RGE_Main_View* this_, uchar param_2, uchar param_3, long param_4, long param_5, RGE_Pick_Info* param_6, RGE_Static_Object* param_7, int param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: unsigned char __thiscall RGE_Main_View::pick1(unsigned char,unsigned char,long,long,struct... *
    //                              *********************************************************************************************************
...
// Offset: 0x0053FFB0
int pick_objects1(RGE_Main_View* this_, long param_2, long param_3, RGE_Static_Object** param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00540010
RGE_Static_Object* pick_best_target(RGE_Main_View* this_, long param_2, long param_3, int* param_4, short param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: class RGE_Static_Object * __thiscall RGE_Main_View::pick_best_target(long,long,int *,short)   *
    //                              *********************************************************************************************************
...
uchar RGE_Main_View::get_help_info(char** param_1, long* param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: virtual unsigned char __thiscall RGE_Main_View::get_help_info(char * &,long &,long,long)   *
    //                              *********************************************************************************************************
...
// Offset: 0x00540680
void fixup_pick_info(RGE_Main_View* this_, RGE_Pick_Info* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00540700
void reset_display_object_selection(RGE_Main_View* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
