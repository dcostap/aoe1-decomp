// Auto-generated scaffold unit: tact_cnv.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tact_cnv.cpp
#include "../include/common.h"

// Offset: 0x004CD9E0
undefined TRIBE_Action_Convert(TRIBE_Action_Convert* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CDA90
undefined TRIBE_Action_Convert(TRIBE_Action_Convert* this_, RGE_Action_Object* param_2, RGE_Task* param_3, RGE_Static_Object* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CDB20
undefined TRIBE_Action_Convert(TRIBE_Action_Convert* this_, RGE_Action_Object* param_2, RGE_Task* param_3, float param_4, float param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Convert::TRIBE_Action_Convert(class RGE_Action_Object *,class RGE_... *
    //                              *********************************************************************************************************
...
// Offset: 0x004CE4B0
void martyrdom(TRIBE_Action_Convert* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
