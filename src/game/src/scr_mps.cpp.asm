// Auto-generated scaffold unit: scr_mps.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/scr_mps.cpp
#include "../include/common.h"

// Offset: 0x004A00B0
undefined TribeMPSetupScreen(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A0D80
void init_vars(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A1300
void TribeMPSetupScreen(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A2060
int startGame(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A27A0
void calcRandomPositions(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A2910
void showNetInfo(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A2BA0
void cancelScreen(TribeMPSetupScreen* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A37D0
void fillPlayers(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A4100
void fillChat(TribeMPSetupScreen* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A4190
void updateSummary(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A4FC0
void kickPlayer(TribeMPSetupScreen* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A5020
void handleKickedPlayer(TribeMPSetupScreen* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A5060
void activateVictoryPanels(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A5130
void setupTabOrder(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A5210
void setupSinglePlayerPlayers(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A5440
void fillNumberPlayers(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A54C0
void fillPlayerColors(TribeMPSetupScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A5610
undefined TRIBE_Screen_Wait(TRIBE_Screen_Wait* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A6050
void TRIBE_Screen_Wait(TRIBE_Screen_Wait* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A60E0
void set_text(TRIBE_Screen_Wait* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A6100
void set_text(TRIBE_Screen_Wait* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A61A0
undefined TRIBE_Screen_Disconnect(TRIBE_Screen_Disconnect* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A6290
void TRIBE_Screen_Disconnect(TRIBE_Screen_Disconnect* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A62F0
void set_text(TRIBE_Screen_Disconnect* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A6310
void set_text(TRIBE_Screen_Disconnect* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
