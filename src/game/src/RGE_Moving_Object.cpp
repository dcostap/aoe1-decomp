...
// Fully verified. Marker reconciliation coverage: 0x00460FC0 is a vcall thunk (`mov eax,[ecx]; jmp dword ptr [eax+0x1c8]`) emitted in bucket_0460 and referenced by move_obj pathing dispatch.
