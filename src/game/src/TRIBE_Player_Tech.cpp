...
void TRIBE_Player_Tech::check_for_new_tech() {
    // TODO: PARITY [MODERATE] - This function still has a non-verified marker and needs a strict branch-by-branch parity pass against decomp. [decomp: bucket_050C.decomp @ 0x0050CE68]
