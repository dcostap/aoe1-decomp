...
// TODO: MISSING_FUNC - Group14 mapping note: scr_cam.cpp.decomp corresponds to TRIBE_Campaign_Editor_Screen.cpp (there is no separate TRIBE_Screen_Campaign.cpp TU in this tree).
