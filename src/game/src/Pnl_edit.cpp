...
long TEditPanel::setup(TDrawArea* render_area, TPanel* parent, long x, long y, long w, long h, void* font, short fixed_len_in, char* initial_text, FormatType format_in, int auto_sel_in) {
    ...
    // TODO: PARITY [MODERATE] - CreateWindowEx style mask differs from decomp expression (0x40200044 multiline / 0x40000080 single-line); verify current WS_*/ES_* composition matches original bit-exact behavior. [decomp: pnl_edit.cpp.decomp @ 0x00475770]
