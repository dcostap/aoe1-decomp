// Auto-generated scaffold unit: com_sess.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/com_sess.cpp
#include "../include/common.h"

// Offset: 0x00432200
undefined TCommunications_Sessions(TCommunications_Sessions* this_, TCommunications_Handler* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TCommunications_Sessions::TCommunications_Sessions(class TCommunications_Handle... *
    //                              *********************************************************************************************************
...
// Offset: 0x00432290
void TCommunications_Sessions(TCommunications_Sessions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004322A0
void EraseInformation(TCommunications_Sessions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004322C0
int GetSessionCount(TCommunications_Sessions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004322D0
char* GetSessionName(TCommunications_Sessions* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004322F0
ulong GetSessionMaxPlayers(TCommunications_Sessions* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432320
ulong GetSessionCurrentPlayers(TCommunications_Sessions* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432350
_GUID* GetSessionGUID(TCommunications_Sessions* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432380
int IncSessionCount(TCommunications_Sessions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00432390
int AddSession(TCommunications_Sessions* this_, _GUID param_2, _GUID param_3, ulong param_4, ulong param_5, char* param_6, char* param_7, ulong param_8, ulong param_9, ulong param_10, ulong param_11) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004324F0
int Refresh(TCommunications_Sessions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004325E0
int IsEqualGuid(TCommunications_Sessions* this_, _GUID* param_2, _GUID* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
