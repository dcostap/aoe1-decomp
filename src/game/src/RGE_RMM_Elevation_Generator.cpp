...
uchar RGE_RMM_Elevation_Generator::base_elevation_generate(RGE_Elevation_Info_Line param_1) {
    ...
    Map_Stack stack[99];
    Map_Stack loc_stack;
    // TODO: PARITY [MODERATE] - This transliteration clamps clump count to [0,99], while decomp iterates raw param_1.clumps against fixed local arrays. [decomp: rmm_elev.cpp.decomp @ 0x00484D00]
