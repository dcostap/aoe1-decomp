// TODO: PARITY [MODERATE] - Missing function implementation for TRIBE_Map::scalar_deleting_destructor. [decomp: TRIBE_Map.decomp @ 0x0050F740]
...
void TRIBE_Map::load_random_map(char* p1, char* p2, char* p3, char* p4) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x0050F860
...
void TRIBE_Map::check_tile_for_forest_change(short p1, short p2, RGE_Game_World* p3) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x0050F8D0
...
void TRIBE_Map::change_terrain(short p1, short p2, uchar p3, RGE_Game_World* p4) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x0050FA90
    if (this->map_row_offset == nullptr || p1 < 0 || p2 < 0 || p1 >= this->map_width || p2 >= this->map_height) {
        return;
    }
...
RGE_Static_Object* TRIBE_Map::find_cliff(long p1, long p2) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x0050FF20
...
TRIBE_Cliff_Info TRIBE_Map::get_cliff_info(RGE_Static_Object* p1) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x00510020
...
uchar TRIBE_Map::check_cliff_valid(TRIBE_Cliff_Info p1) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x005100D0
...
RGE_Static_Object* TRIBE_Map::make_new_cliff(long p1, long p2, TRIBE_Cliff_Info p3) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x00510110
...
void TRIBE_Map::remove_cliff_edge(long p1, long p2, long p3) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x005102A0
    switch (p3) {
    case 0:
        p1 = p1 + 1;
...
long TRIBE_Map::reverse_cliff_direction(long p1) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x00510410
    long out = p1 + 2;
    if (out > 3) {
        out = p1 - 2;
    }
...
long TRIBE_Map::add_cliff_edge(long p1, long p2, long p3, long p4, long p5) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x00510430
    RGE_Static_Object* cliff = this->find_cliff(p1, p2);
    TRIBE_Cliff_Info cliff_info = this->get_cliff_info(cliff);
...
uchar TRIBE_Map::do_cliff_brush(long p1, long p2, uchar p3, uchar p4) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x00510A50
    long cliff_x = p1 / 3;
    long cliff_y = p2 / 3;
...
void TRIBE_Map::map_generate(RGE_Player_Info* p1) {
    (void)p1;
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x0050F7F0
}
...
void TRIBE_Map::delete_cliff(long p1, long p2) {
    // Fully verified. Source of truth: tmap.cpp.decomp @ 0x00510960
    RGE_Static_Object* cliff = this->find_cliff(p1, p2);
    TRIBE_Cliff_Info cliff_info = this->get_cliff_info(cliff);
    if (cliff == nullptr) {
        return;
