// Auto-generated scaffold unit: m_dg_obj.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/m_dg_obj.cpp
#include "../include/common.h"

// Offset: 0x004510C0
undefined RGE_Master_Doppleganger_Object(RGE_Master_Doppleganger_Object* this_, RGE_Master_Doppleganger_Object* param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00451140
undefined RGE_Master_Doppleganger_Object(RGE_Master_Doppleganger_Object* this_, int param_2, RGE_Sprite** param_3, RGE_Sound** param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004511B0
undefined RGE_Master_Doppleganger_Object(RGE_Master_Doppleganger_Object* this_, FILE* param_2, RGE_Sprite** param_3, RGE_Sound** param_4, short param_5, int param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00451230
int setup(RGE_Master_Doppleganger_Object* this_, RGE_Master_Doppleganger_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00451250
int setup(RGE_Master_Doppleganger_Object* this_, int param_2, RGE_Sprite** param_3, RGE_Sound** param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00451280
int setup(RGE_Master_Doppleganger_Object* this_, FILE* param_2, RGE_Sprite** param_3, RGE_Sound** param_4, short param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004512C0
void RGE_Master_Doppleganger_Object(RGE_Master_Doppleganger_Object* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
