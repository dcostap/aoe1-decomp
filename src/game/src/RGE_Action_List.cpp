...
// TODO: PARITY [LOW] - Validate this shim offset remains non-callable and that no switch case implementation was dropped. [decomp: act_list.cpp.decomp @ 0x004041C2]
// Fully verified. Source of truth: act_list.cpp.decomp @ 0x0040496E
// ASM shows a switch jump-table shim (MOV EDI, EDI), not a standalone callable function body.
// TODO: PARITY [LOW] - Validate this shim offset remains non-callable and that no switch case implementation was dropped. [decomp: act_list.cpp.decomp @ 0x0040496E]
