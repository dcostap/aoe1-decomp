...
// Fully verified. Source of truth: act_list.cpp.decomp @ 0x004041C2, act_list.cpp.asm @ 0x004041C2
// ASM shows a switch jump-table shim (MOV EDI, EDI), not a standalone callable function body.
// Fully verified. Source of truth: act_list.cpp.decomp @ 0x0040496E, act_list.cpp.asm @ 0x0040496E
// ASM shows a switch jump-table shim (MOV EDI, EDI), not a standalone callable function body.
