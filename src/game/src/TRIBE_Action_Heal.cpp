...
// TODO: PARITY [MODERATE] - No-op anchor should be verified against ASM to ensure no missed branch logic in this corrupted decomp region. [decomp: tact_hea.cpp.decomp @ 0x004CECC6]
