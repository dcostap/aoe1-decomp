// Auto-generated scaffold unit: infmap.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/infmap.cpp
#include "../include/common.h"

// Offset: 0x0044DF80
undefined InfluenceMap(InfluenceMap* this_, int param_2, int param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E050
undefined InfluenceMap(InfluenceMap* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E080
void InfluenceMap(InfluenceMap* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E0B0
int initialize(InfluenceMap* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E0F0
void save(InfluenceMap* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E1A0
void load(InfluenceMap* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E250
void printToFile(InfluenceMap* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E4C0
void setReferencePoint(InfluenceMap* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E4E0
int lookupValue(InfluenceMap* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E510
int setValue(InfluenceMap* this_, int param_2, int param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E560
int setValue(InfluenceMap* this_, int param_2, int param_3, int param_4, int param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E600
int incrementValue(InfluenceMap* this_, int param_2, int param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E680
int incrementValue(InfluenceMap* this_, int param_2, int param_3, int param_4, int param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E790
int decrementValue(InfluenceMap* this_, int param_2, int param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E800
int decrementValue(InfluenceMap* this_, int param_2, int param_3, int param_4, int param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E900
int setCoverageCount(InfluenceMap* this_, XYPoint* param_2, XYPoint* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044E9E0
int setConnectionCount(InfluenceMap* this_, XYPoint* param_2, XYPoint* param_3, int param_4, int param_5, int param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044EC00
int coverageIncluding(InfluenceMap* this_, XYPoint* param_2, XYPoint* param_3, uchar param_4, uchar param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044ED20
int connectionsIncluding(InfluenceMap* this_, XYPoint* param_2, XYPoint* param_3, uchar param_4, uchar param_5, int param_6, int param_7, int param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F030
void setUnchangeableLimit(InfluenceMap* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F040
int maxValue(InfluenceMap* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
