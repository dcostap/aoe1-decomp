// Auto-generated scaffold unit: Path.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/Path.cpp
#include "../include/common.h"

// Offset: 0x0046A740
undefined Path(Path* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046A810
ostream* operator(ostream* param_1, Path* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046A8E0
Path operator(Path* this_, Path* return_storage_ptr, Path* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046A9E0
Path* operator(Path* this_, Path* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AAE0
int operator(Path* this_, Path* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AB60
int insertAtCurrent(Path* this_, Waypoint* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AC10
int insertAtEnd(Path* this_, Waypoint param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046ACE0
int contains(Path* this_, Waypoint* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046ADB0
int maxNumberOfWaypoints(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046ADC0
int numberOfWaypoints(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046ADE0
void setTimeStamp(Path* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AE70
Waypoint* waypoint(Path* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AEA0
Waypoint* currentWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AEC0
int currentWaypointNumber(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AED0
void setCurrentWaypointNumber(Path* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AEE0
Waypoint* nextWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AF10
Waypoint* previousWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AF40
Waypoint* firstWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AF60
Waypoint* lastWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AFA0
int moveToNextWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AFC0
int moveToLastWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046AFE0
float distanceToNextWaypoint(Path* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
