// Auto-generated scaffold unit: tact_bld.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tact_bld.cpp
#include "../include/common.h"

// Offset: 0x004CD1B0
undefined TRIBE_Action_Build(TRIBE_Action_Build* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CD210
undefined TRIBE_Action_Build(TRIBE_Action_Build* this_, RGE_Action_Object* param_2, RGE_Task* param_3, RGE_Static_Object* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Build::TRIBE_Action_Build(class RGE_Action_Object *,class RGE_Task... *
    //                              *********************************************************************************************************
...
// Offset: 0x004CD2A0
undefined TRIBE_Action_Build(TRIBE_Action_Build* this_, RGE_Action_Object* param_2, RGE_Task* param_3, float param_4, float param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Build::TRIBE_Action_Build(class RGE_Action_Object *,class RGE_Task... *
    //                              *********************************************************************************************************
...
undefined FUN_004cd5a5() {
    ...
    //                               FUN_004cd5a5
    //         004cd5a5     NOP
    //         004cd5a6     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_004cd347::switchdataD_004cd5a8                       XREF[1]:     set_state:004cd347(*)  
}
...
int TRIBE_Action_Build::move_to(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall TRIBE_Action_Build::move_to(class RGE_Static_Object *,float,float,f... *
    //                              *********************************************************************************************************
...
int TRIBE_Action_Build::work(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall TRIBE_Action_Build::work(class RGE_Static_Object *,float,float,float)  *
    //                              *********************************************************************************************************
