// Auto-generated scaffold unit: obj_list.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/obj_list.cpp
#include "../include/common.h"

// Offset: 0x00462E80
undefined RGE_Object_List(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462EA0
void RGE_Object_List(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_Object_List::~RGE_Object_List(void)                                            *
    //                              *********************************************************************************************************
...
// Offset: 0x00462EF0
void removeAllObjects(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462F30
RGE_Object_Node* add_node(RGE_Object_List* this_, RGE_Static_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462F70
void remove_node(RGE_Object_List* this_, RGE_Static_Object* param_2, RGE_Object_Node* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462FD0
void invert(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463000
void draw(RGE_Object_List* this_, TDrawArea* param_2, short param_3, short param_4, uchar param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463100
void shadow_draw(RGE_Object_List* this_, TDrawArea* param_2, short param_3, short param_4, uchar param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463180
void normal_draw(RGE_Object_List* this_, TDrawArea* param_2, short param_3, short param_4, uchar param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463210
void update(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463260
RGE_Object_Node* sort(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004632E0
RGE_Static_Object* find_by_group(RGE_Object_List* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463310
RGE_Static_Object* find_by_group(RGE_Object_List* this_, long param_2, float param_3, float param_4, uchar param_5, uchar param_6, RGE_Static_Object* param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463490
RGE_Static_Object* find_by_id(RGE_Object_List* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004634C0
RGE_Static_Object* find_by_master_id(RGE_Object_List* this_, long param_2, float param_3, float param_4, uchar param_5, uchar param_6, RGE_Static_Object* param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463640
RGE_Static_Object* find_by_master_ids(RGE_Object_List* this_, long param_2, long param_3, float param_4, float param_5, uchar param_6, uchar param_7, RGE_Static_Object* param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004637C0
RGE_Static_Object* find_by_type(RGE_Object_List* this_, uchar param_2, float param_3, float param_4, uchar param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463890
void save(RGE_Object_List* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004638D0
void load_list(RGE_Object_List* this_, int param_2, RGE_Game_World* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00463910
void rehook_list(RGE_Object_List* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
