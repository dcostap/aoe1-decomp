...
void RGE_Doppleganger_Object::recycle_in_to_game(
    ...
    // TODO: PARITY [MODERATE] - CUSTOM_DEBUG logging and call-counter side effects in this routine are non-original instrumentation absent from the decomp body. [decomp: dpl_obj.cpp.decomp @ 0x00441BB0]
    CUSTOM_DEBUG_BEGIN
