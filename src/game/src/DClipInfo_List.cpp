...
// TODO: PARITY - Additional view.cpp.decomp methods (GetNode/AddDrawNode/LocateIDbyDrawLevel/Scroll/FreeNode/FreeThread/ResetStats) are still absent from this TU and need explicit ownership mapping. [decomp: view.cpp.decomp @ 0x0053B000]
