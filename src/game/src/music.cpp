...
TMusic_System::TMusic_System(uchar mtype, void* inst, void* wnd, TSound_Driver* snd, char* p) {
    ...
    this->file_name[0] = '\0';
    // TODO: PARITY [MODERATE] - last_check_time initialization is not explicitly present in the decomp ctor listing; confirm this extra field init matches original behavior. [decomp: music.cpp.decomp @ 0x00461910]
