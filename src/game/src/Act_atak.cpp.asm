// Auto-generated scaffold unit: Act_atak.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/Act_atak.cpp
#include "../include/common.h"

// Offset: 0x00401000
undefined RGE_Action_Attack(RGE_Action_Attack* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00401170
undefined RGE_Action_Attack(RGE_Action_Attack* this_, RGE_Action_Object* param_2, RGE_Static_Object* param_3, RGE_Sprite* param_4, RGE_Sprite* param_5, RGE_Sprite* param_6, float param_7, float param_8, short param_9, short param_10) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_Action_Attack::RGE_Action_Attack(class RGE_Action_Object *,class RGE_Static... *
    //                              *********************************************************************************************************
...
// Offset: 0x004012B0
undefined RGE_Action_Attack(RGE_Action_Attack* this_, RGE_Action_Object* param_2, float param_3, float param_4, float param_5, RGE_Sprite* param_6, RGE_Sprite* param_7, RGE_Sprite* param_8, float param_9, float param_10, short param_11, short param_12) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_Action_Attack::RGE_Action_Attack(class RGE_Action_Object *,float,float,floa... *
    //                              *********************************************************************************************************
    //                              undefined __thiscall RGE_Action_Attack(RGE_Action_Attack * this, RGE
    //              undefined         <UNASSIGNED>   <RETURN>
    //              RGE_Action_Att    ECX:4 (auto)   this
...
// Offset: 0x004013A0
void RGE_Action_Attack(RGE_Action_Attack* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
int RGE_Action_Attack::work(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall RGE_Action_Attack::work(class RGE_Static_Object *,float,float,float)   *
    //                              *********************************************************************************************************
...
// Offset: 0x00401B30
int ready_to_attack(RGE_Action_Attack* this_, int* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00401EC0
void do_attack(RGE_Action_Attack* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
