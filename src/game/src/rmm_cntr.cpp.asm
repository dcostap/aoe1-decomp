// Auto-generated scaffold unit: rmm_cntr.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/rmm_cntr.cpp
#include "../include/common.h"

// Offset: 0x004821A0
undefined RGE_RMM_Controller(RGE_RMM_Controller* this_, RGE_Map* param_2, RGE_Game_World* param_3, uchar param_4, long param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00482270
void add_land_module(RGE_RMM_Controller* this_, RGE_Land_Info* param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004826E0
void add_terrain_module(RGE_RMM_Controller* this_, RGE_Terrain_Info* param_2, RGE_Land_Info* param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004828A0
long count_map_tiles(RGE_RMM_Controller* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004828B0
void add_object_module(RGE_RMM_Controller* this_, RGE_Game_World* param_2, RGE_Land_Info* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
