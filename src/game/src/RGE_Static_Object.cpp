...
static void FUN_004c218d() {
    // Source of truth: stat_obj.cpp.decomp @ 0x004C218D is decompiler jump-table spillover; stat_obj.cpp.asm confirms this landing pad is a no-op thunk.
    // Fully verified. Source of truth: stat_obj.cpp.asm @ 0x004C218D (switch jump-table landing pad).
}

static void FUN_004c2206() {
    // Source of truth: stat_obj.cpp.decomp @ 0x004C2206 is decompiler jump-table spillover; stat_obj.cpp.asm confirms this landing pad is a no-op thunk.
    // Fully verified. Source of truth: stat_obj.cpp.asm @ 0x004C2206 (switch jump-table landing pad).
}

static void FUN_004c22a6() {
    // Source of truth: stat_obj.cpp.decomp @ 0x004C22A6 is decompiler jump-table spillover; stat_obj.cpp.asm confirms this landing pad is a no-op thunk.
    // Fully verified. Source of truth: stat_obj.cpp.asm @ 0x004C22A6 (switch jump-table landing pad).
}

static void FUN_004c3f65() {
    // Source of truth: stat_obj.cpp.decomp @ 0x004C3F65 is decompiler jump-table spillover; stat_obj.cpp.asm confirms this landing pad is a no-op thunk.
