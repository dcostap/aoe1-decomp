// Auto-generated scaffold unit: rmm_clif.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/rmm_clif.cpp
#include "../include/common.h"

// Offset: 0x00481980
undefined RGE_RMM_Cliffs_Generator(RGE_RMM_Cliffs_Generator* this_, RGE_Map* param_2, RGE_Random_Map_Module* param_3, RGE_Cliffs_Info param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_RMM_Cliffs_Generator::RGE_RMM_Cliffs_Generator(class RGE_Map *,class RGE_Ra... *
    //                              *********************************************************************************************************
    //                              undefined __thiscall RGE_RMM_Cliffs_Generator(RGE_RMM_Cliffs_Generat
    //              undefined         <UNASSIGNED>   <RETURN>
    //              RGE_RMM_Cliffs    ECX:4 (auto)   this
    //              RGE_Map *         Stack[0x4]:4   param_1                   XREF[1]:     00481988(R)  
    //              RGE_Random_Map    Stack[0x8]:4   param_2                   XREF[1]:     00481980(R)  
    //              RGE_Cliffs_Info   <UNASSIGNED>   param_3
    //                               ??0RGE_RMM_Cliffs_Generator@@QAE@PAVRGE_Map@@PAVRGE_Random_  XREF[1]:     init:004878e9(c)  
    //                               RGE_RMM_Cliffs_Generator::RGE_RMM_Cliffs_Generator
    //                              rmm_clif.cpp:33 (24)
    //         00481980     MOV        EAX,dword ptr [ESP + param_2]
    //         00481984     PUSH       EBX
    //         00481985     PUSH       ESI
    //         00481986     MOV        EBX,this
    //         00481988     MOV        this,dword ptr [ESP + param_1]
    //         0048198c     PUSH       EDI
    //         0048198d     PUSH       0x1
    //         0048198f     PUSH       EAX
    //         00481990     PUSH       this
    //         00481991     MOV        this,EBX
    //         00481993     CALL       RGE_Random_Map_Module::RGE_Random_Map_Module     undefined RGE_Random_Map_Module(RGE_Random_Ma
    //                              rmm_clif.cpp:34 (20)
    //         00481998     LEA        EDI,[EBX + 0x30]
    //         0048199b     MOV        this,0x130
    //         004819a0     LEA        ESI=>Stack[0xc],[ESP + 0x18]
    //         004819a4     MOV        dword ptr [EBX],RGE_RMM_Cliffs_Generator::`vft   = 004819c0
    //         004819aa     MOVSD.REP  ES:EDI,ESI
    //                              rmm_clif.cpp:37 (15)
    //         004819ac     POP        EDI
    //         004819ad     MOV        dword ptr [EBX + 0x1c],0x3fe00000
    //         004819b4     MOV        EAX,EBX
    //         004819b6     POP        ESI
    //         004819b7     POP        EBX
    //         004819b8     RET        0x4c8
}
...
// Offset: 0x00481A00
void setup_cliff_maps(RGE_RMM_Cliffs_Generator* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00481CD0
void generate_cliff(RGE_RMM_Cliffs_Generator* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00481FC0
uchar check_for_valid_cliff_site(RGE_RMM_Cliffs_Generator* this_, long param_2, long* param_3, long* param_4, long param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004820A0
void invalidate_cliff_area(RGE_RMM_Cliffs_Generator* this_, long param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
