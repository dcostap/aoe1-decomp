// Auto-generated scaffold unit: music.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/music.cpp
#include "../include/common.h"

// Offset: 0x00461910
undefined TMusic_System(TMusic_System* this_, uchar param_2, void* param_3, void* param_4, TSound_Driver* param_5, char* param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461A20
void TMusic_System(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461A30
int open_device(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461C60
void close_device(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461D20
int open_mixer(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461EC0
void close_mixer(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461F00
int set_music_type(TMusic_System* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461F40
void set_fade_out(TMusic_System* this_, int param_2, ulong param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00461F60
void set_volume(TMusic_System* this_, long param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462010
int play_track(TMusic_System* this_, int param_2, int param_3, ulong param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462090
int play_file(TMusic_System* this_, char* param_2, int param_3, ulong param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462140
int play_tracks(TMusic_System* this_, int param_2, int param_3, int param_4, int param_5, ulong param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462200
int play(TMusic_System* this_, int param_2, int param_3, char* param_4, int param_5, ulong param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004625C0
int pause_play(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462670
int resume_play(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462740
int stop_track(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462770
int stop_playing(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462820
int fade_track(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462860
void start_fade(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004628A0
void do_fade(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004629B0
void end_fade(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462A10
uint handle_messages(TMusic_System* this_, void* param_2, uint param_3, uint param_4, long param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: unsigned int __thiscall TMusic_System::handle_messages(void *,unsigned int,unsigned int,long) *
    //                              *********************************************************************************************************
...
// Offset: 0x00462B40
void after_end_track(TMusic_System* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00462C30
int get_play_info(TMusic_System* this_, uchar* param_2, int* param_3, int* param_4, int* param_5, char* param_6, int* param_7, ulong* param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
