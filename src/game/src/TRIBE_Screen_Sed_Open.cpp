// TODO: PARITY - Missing function implementation for TRIBE_Screen_Sed_Open::scalar_deleting_destructor. [decomp: TRIBE_Screen_Sed_Open.decomp @ 0x004B3680]
...
long TRIBE_Screen_Sed_Open::setup(TDrawArea* param_1, TPanel* param_2, long param_3, long param_4, long param_5, long param_6, uchar param_7) { return TScreenPanel::setup(param_1, param_2, param_3, param_4, param_5, param_6, param_7); }
    // Fully verified. Source of truth: TRIBE_Screen_Sed_Open vtable parity (forwarding wrapper).
