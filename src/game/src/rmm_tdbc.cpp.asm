// Auto-generated scaffold unit: rmm_tdbc.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/rmm_tdbc.cpp
#include "../include/common.h"

// Offset: 0x004876C0
undefined TRIBE_RMM_Database_Controller(TRIBE_RMM_Database_Controller* this_, char* param_2, char* param_3, char* param_4, char* param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_RMM_Database_Controller::TRIBE_RMM_Database_Controller(char *,char *,char... *
    //                              *********************************************************************************************************
...
// Offset: 0x004876F0
undefined TRIBE_RMM_Database_Controller(TRIBE_RMM_Database_Controller* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004887A0
void add_shallows_module(TRIBE_RMM_Database_Controller* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
