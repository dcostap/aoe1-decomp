// Auto-generated scaffold unit: Pnl_drop.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/Pnl_drop.cpp
#include "../include/common.h"

// Offset: 0x00473ED0
undefined TDropDownPanel(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00473F50
void TDropDownPanel(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00473FD0
long setup(TDropDownPanel* this_, TDrawArea* param_2, TPanel* param_3, void* param_4, long param_5, long param_6, int param_7, uchar param_8, int param_9, uchar param_10, long param_11, long param_12, long param_13, long param_14, short param_15, short param_16, long param_17, long param_18, char* param_19, long param_20, long param_21, char** param_22, short param_23, long param_24, char* param_25, char* param_26, char* param_27, char* param_28, long param_29, long param_30) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: long __thiscall TDropDownPanel::setup(class TDrawArea *,class TPanel *,void *,long,long,in... *
    //                              *********************************************************************************************************
...
long TDropDownPanel::handle_mouse_down(uchar param_1, long param_2, long param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual long __thiscall TDropDownPanel::handle_mouse_down(unsigned char,long,long,int,int)    *
    //                              *********************************************************************************************************
...
// Offset: 0x004745E0
void set_val_text_color(TDropDownPanel* this_, ulong param_2, ulong param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00474600
void set_draw_style(TDropDownPanel* this_, DrawStyle param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00474630
void set_draw_val_rect(TDropDownPanel* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00474670
void set_bevel_info(TDropDownPanel* this_, int param_2, int param_3, int param_4, int param_5, int param_6, int param_7, int param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00474820
void set_buttons(TDropDownPanel* this_, TShape* param_2, int param_3, int param_4, int param_5, int param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00474880
void set_mode(TDropDownPanel* this_, DropdownMode param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475110
int numberLines(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475130
int currentLineNumber(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475150
void setCurrentLineNumber(TDropDownPanel* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475160
void setCurrentLineId(TDropDownPanel* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004751C0
char* currentLine(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475210
void set_sorted(TDropDownPanel* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475230
int get_sorted(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475250
void set_line(TDropDownPanel* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004752A0
int append_line(TDropDownPanel* this_, char* param_2, long param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004752D0
int append_line(TDropDownPanel* this_, long param_2, long param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475300
int insert_line(TDropDownPanel* this_, long param_2, char* param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475330
int insert_line(TDropDownPanel* this_, long param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475360
int delete_line(TDropDownPanel* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475380
long get_line(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004753A0
long get_line(TDropDownPanel* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004753C0
long get_line(TDropDownPanel* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004753E0
char* get_text(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475400
char* get_text(TDropDownPanel* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475420
long get_id(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475440
long get_id(TDropDownPanel* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475460
void empty_list(TDropDownPanel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00475470
undefined TDropDownButtonPanel(TDropDownButtonPanel* this_, TDropDownPanel* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
