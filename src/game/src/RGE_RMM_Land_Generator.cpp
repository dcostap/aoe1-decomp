...
uchar RGE_RMM_Land_Generator::base_land_generate() {
    ...
    // TODO: PARITY [MODERATE] - Loops in this function cap processing at 99 entries, while decomp walks full info.land_num across stack/land_size local arrays. [decomp: rmm_land.cpp.decomp @ 0x00485520]
