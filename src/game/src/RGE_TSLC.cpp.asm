// Auto-generated scaffold unit: RGE_TSLC.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/RGE_TSLC.cpp
#include "../include/common.h"

// Offset: 0x00480390
undefined RGE_TimeSinceLastCall(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004803F0
void RGE_TimeSinceLastCall(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_TimeSinceLastCall::~RGE_TimeSinceLastCall(void)                                *
    //                              *********************************************************************************************************
...
// Offset: 0x00480400
ulong GetAvg(RGE_TimeSinceLastCall* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480460
ulong Get(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480480
ulong Set(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480510
void Skip(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480540
char* GetAvgInfo(RGE_TimeSinceLastCall* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480570
char* GetHiLoMaxInfo(RGE_TimeSinceLastCall* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480610
char* GetHiLoInfo(RGE_TimeSinceLastCall* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004806A0
ulong CPS(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004806C0
ulong GetFirstCall(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004806D0
char* GetElapsedFirstCall(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00480770
void Test(RGE_TimeSinceLastCall* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
