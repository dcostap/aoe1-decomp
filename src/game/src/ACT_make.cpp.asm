// Auto-generated scaffold unit: ACT_make.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/ACT_make.cpp
#include "../include/common.h"

// Offset: 0x004049B0
undefined RGE_Action_Make(RGE_Action_Make* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00404A10
undefined RGE_Action_Make(RGE_Action_Make* this_, RGE_Action_Object* param_2, RGE_Task* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
