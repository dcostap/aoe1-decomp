// Auto-generated scaffold unit: scr_save.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/scr_save.cpp
#include "../include/common.h"

// Offset: 0x004A71F0
undefined TribeSaveGameScreen(TribeSaveGameScreen* this_, Mode param_2, char* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A75C0
void TribeSaveGameScreen(TribeSaveGameScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004A7670
void fillList(TribeSaveGameScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
long TribeSaveGameScreen::action(TPanel* param_1, long param_2, ulong param_3, ulong param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: virtual long __thiscall TribeSaveGameScreen::action(class TPanel *,long,unsigned long,u... *
    //                              *********************************************************************************************************
...
// Offset: 0x004A8060
void save_for_scenario_editor(TribeSaveGameScreen* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
