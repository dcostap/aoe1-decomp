// Auto-generated scaffold unit: com_q.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/com_q.h
#include "../include/common.h"

// Offset: 0x00431720
undefined RGE_Communications_Queue(RGE_Communications_Queue* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431760
void RGE_Communications_Queue(RGE_Communications_Queue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431810
int AllocateQueue(RGE_Communications_Queue* this_, uint param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004319E0
uchar ExpectedNextSequence(RGE_Communications_Queue* this_, ulong param_2, uint param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431A40
uint QueuedForTurn(RGE_Communications_Queue* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431A70
void FlushAll(RGE_Communications_Queue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431A80
uint FlushTurnRange(RGE_Communications_Queue* this_, ulong param_2, ulong param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: unsigned int __thiscall RGE_Communications_Queue::FlushTurnRange(unsigned long,unsigned long) *
    //                              *********************************************************************************************************
...
// Offset: 0x00431B10
void FlushForPlayer(RGE_Communications_Queue* this_, uint param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431BD0
uint FlushForTurn(RGE_Communications_Queue* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431BE0
uint FlushThruTurn(RGE_Communications_Queue* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431BF0
int AddItem(RGE_Communications_Queue* this_, ulong param_2, void* param_3, ulong param_4, uint param_5, uchar param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431D10
uint GetQueueDepth(RGE_Communications_Queue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431D20
uint GetHighQueueDepth(RGE_Communications_Queue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431D30
void* GetSpecificItem(RGE_Communications_Queue* this_, uint param_2, ulong param_3, uchar param_4, uint* param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431DD0
void* GetNextItemSingle(RGE_Communications_Queue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431E40
void* GetNextItemOrdered(RGE_Communications_Queue* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431F10
uchar GetNextSequence(RGE_Communications_Queue* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431F50
void TestShowQueue(RGE_Communications_Queue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00431F60
undefined MsgQueue(MsgQueue* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
