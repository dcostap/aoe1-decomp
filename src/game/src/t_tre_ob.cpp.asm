// Auto-generated scaffold unit: t_tre_ob.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/t_tre_ob.cpp
#include "../include/common.h"

// Offset: 0x004CCA60
undefined TRIBE_Tree_Object(TRIBE_Tree_Object* this_, TRIBE_Master_Tree_Object* param_2, RGE_Player* param_3, float param_4, float param_5, float param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Tree_Object::TRIBE_Tree_Object(class TRIBE_Master_Tree_Object *,class RGE... *
    //                              *********************************************************************************************************
...
// Offset: 0x004CCB20
undefined TRIBE_Tree_Object(TRIBE_Tree_Object* this_, int param_2, RGE_Game_World* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
