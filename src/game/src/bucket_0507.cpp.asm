// Auto-generated scaffold unit: bucket_0507.cpp.asm
#include "../include/common.h"

// Offset: 0x00507190
void TribeSoldierUnitAIModule(TribeSoldierUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00507A20
void TribeArtifactUnitAIModule(TribeArtifactUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
