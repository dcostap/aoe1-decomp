...
void TransDibBlt(BITMAPINFO256* param_1, uchar* param_2, tagRECT* param_3, long param_4, long param_5, long param_6, long param_7,
    ...
    // TODO: PARITY [MODERATE] - Decomp warns on `SrcTotHgt`; verify source-orientation/sign handling and clipped-row stepping match asm for this blit path. [decomp: dib.cpp.decomp @ 0x00438AA0]
    int iVar6 = param_17;
