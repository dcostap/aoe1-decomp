// Auto-generated scaffold unit: tpnl_btn.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tpnl_btn.cpp
#include "../include/common.h"

// Offset: 0x00519DA0
undefined TRIBE_Panel_Button(TRIBE_Panel_Button* this_, TDrawArea* param_2, TPanel* param_3, TDigital* param_4, void* param_5, long param_6, long param_7, TShape* param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00519EA0
void set_text_msg(TRIBE_Panel_Button* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051A570
void set_display_garrison(TRIBE_Panel_Button* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051A590
void set_garrison_number(TRIBE_Panel_Button* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051A5B0
int get_garrison_number(TRIBE_Panel_Button* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
