// Auto-generated scaffold unit: rmm_base.cpp.asm
...
undefined RGE_Random_Map_Module(RGE_Random_Map_Module* this_, RGE_Map* param_2, RGE_Random_Map_Module* param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_Random_Map_Module::RGE_Random_Map_Module(class RGE_Map *,class RGE_Random_M... *
    //                              *********************************************************************************************************
...
uchar find_path(RGE_Random_Map_Module* this_, long param_2, long param_3, long* param_4, long* param_5, float* param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: unsigned char __thiscall RGE_Random_Map_Module::find_path(long,long,long &,long &,float *) *
    //                              *********************************************************************************************************
