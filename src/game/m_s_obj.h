...
public:
    ...
    virtual void copy_obj(RGE_Master_Static_Object* param_1); // vt0[1]+0x4=0x453120
    virtual void modify(float param_1, uchar param_2);      // vt0[2]+0x8=0x4534A0
    virtual void modify_delta(float param_1, uchar param_2); // vt0[3]+0xC=0x453540
    virtual void modify_percent(float param_1, uchar param_2); // vt0[4]+0x10=0x4535F0
    virtual void save(int param_1);                         // vt0[5]+0x14=0x4536D0
    virtual RGE_Static_Object* make_new_obj(RGE_Player* param_1, float param_2, float param_3, float param_4); // vt0[6]+0x18=0x452FE0
    virtual RGE_Master_Static_Object* make_new_master();    // vt0[7]+0x1C=0x4530B0
    virtual uchar check_placement(RGE_Player* param_1, float param_2, float param_3, int* param_4, uchar param_5, uchar param_6, uchar param_7, uchar param_8, uchar param_9, uchar param_10); // vt0[8]+0x20=0x453C40
    virtual uchar alignment(float* param_1, float* param_2, RGE_Game_World* param_3, uchar param_4); // vt0[9]+0x24=0x4543D0
    virtual long calc_base_damage_ability(RGE_Master_Combat_Object* param_1); // vt0[10]+0x28=0x454980
    virtual void play_command_sound();                      // vt0[11]+0x2C=0x44FE20
    virtual void play_move_sound();                         // vt0[12]+0x30=0x44FE30
    virtual void draw(TDrawArea* param_1, short param_2, short param_3, RGE_Color_Table* param_4, long param_5, long param_6, int param_7, uchar param_8); // vt0[13]+0x34=0x4547F0
