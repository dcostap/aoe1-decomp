...
uchar RGE_RMM_Database_Controller::generate() {
    ...
    //         0048353e     NOP
    //         0048353f     NOP
    //                              * public: virtual unsigned char __thiscall RGE_RMM_Database_Controller::init(class RGE_Map *,class R... *
...
uchar RGE_RMM_Database_Controller::de_init() {
    ...
    //         004835fe     NOP
    //         004835ff     NOP
    //                              * protected: void __thiscall RGE_RMM_Database_Controller::calc_land_start(long,long,long,struct RGE_... *
