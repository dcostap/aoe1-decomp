...
public:
    ...
    virtual  ~TScrollTextPanel() noexcept(false); // Ghidra: `vector_deleting_destructor'
...
public:
    ...
    // [Slot 00] Offset 0x00 (Override)
    virtual  ~TRIBE_Credits_Screen() noexcept(false); // Ghidra: `scalar_deleting_destructor'
