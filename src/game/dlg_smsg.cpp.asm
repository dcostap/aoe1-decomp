...
TribeSendMessageDialog::TribeSendMessageDialog(TScreenPanel* param_1) {
    /* TODO: Stub */
...
TribeSendQuickMessageDialog::TribeSendQuickMessageDialog(TScreenPanel* param_1, Mode param_2) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
}
