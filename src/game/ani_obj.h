...
public:
    ...
    virtual  ~RGE_Animated_Object() noexcept(false); // Ghidra: `scalar_deleting_destructor'
    ...
    // [Slot 122] Offset 0x1E8 (Override)
    virtual int setup(RGE_Master_Animated_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5); // Ghidra: setup
