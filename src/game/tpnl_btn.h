...
public:
    ...
    virtual void draw();                                    // vt0[12]+0x30=0x519F40
    virtual int is_inside(long param_1, long param_2);      // vt0[47]+0xBC=0x519EE0
    ...
    ~TRIBE_Panel_Button();
    void set_text_msg(char* param_1);
    void set_display_garrison(int param_1);
    void set_garrison_number(int param_1);
