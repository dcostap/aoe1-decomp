...
public:
    ...
    virtual  ~TribeGameSettingsScreen() noexcept(false); // Ghidra: `vector_deleting_destructor'
...
static_assert(offsetof(TribeGameSettingsScreen, last_send_shared) == 0x55C, "TribeGameSettingsScreen Offset Mismatch");
