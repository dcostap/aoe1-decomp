...
public:
    ...
    virtual  ~TDialogPanel() noexcept(false); // Ghidra: `vector_deleting_destructor'
    ...
    virtual int setup(TDrawArea* param_1, TPanel* param_2, long param_3, long param_4, uchar param_5, int param_6); // Ghidra: setup

    // [Slot 75] Offset 0x12C (Override)
    virtual int setup(TDrawArea* param_1, TPanel* param_2, long param_3, long param_4, char* param_5, long param_6, int param_7); // Ghidra: setup
