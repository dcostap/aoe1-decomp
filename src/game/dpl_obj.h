...
public:
    ...
    ~RGE_Doppleganger_Creator() noexcept(false);
    // --- Non-Virtual Members ---
...
public:
    ...
    virtual  ~RGE_Doppleganger_Object() noexcept(false); // Ghidra: `scalar_deleting_destructor'
    ...
    virtual void recycle_in_to_game(RGE_Master_Static_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5, RGE_Static_Object* param_6); // Ghidra: recycle_in_to_game

    // [Slot 124] Offset 0x1F0 (Override)
    virtual void validate(); // Ghidra: validate

    // [Slot 125] Offset 0x1F4 (Override)
    virtual int setup(RGE_Master_Doppleganger_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5); // Ghidra: setup
