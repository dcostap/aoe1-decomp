// Auto-generated scaffold unit: victory.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/victory.cpp
#include "../include/common.h"

// Offset: 0x00531750
undefined RGE_Victory_Conditions(RGE_Victory_Conditions* this_, RGE_Player* param_2, int param_3, long* param_4, uchar param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_Victory_Conditions::RGE_Victory_Conditions(class RGE_Player *,int,long *,un... *
    //                              *********************************************************************************************************
...
// Offset: 0x00531AF0
undefined RGE_Victory_Conditions(RGE_Victory_Conditions* this_, RGE_Player* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00531B20
void RGE_Victory_Conditions(RGE_Victory_Conditions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00531DB0
void check_for_victory(RGE_Victory_Conditions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00531E90
uchar update(RGE_Victory_Conditions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00531EF0
void update_for_object(RGE_Victory_Conditions* this_, RGE_Static_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532050
void handle_capture(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532110
void handle_create(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532220
void handle_create_in_area(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005323B0
void handle_destroy(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005323D0
void handle_destroy_multiple(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005324A0
void handle_destroy_all(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532570
void handle_destroy_player(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005325A0
void handle_bring_area(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532610
void handle_bring_object(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005326F0
void handle_attribute(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005327A0
void handle_explore(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532880
void handle_victory_points(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532930
RGE_Victory_Entry* add(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532970
uchar add_capture(RGE_Victory_Conditions* this_, uchar param_2, RGE_Static_Object* param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005329A0
uchar add_create(RGE_Victory_Conditions* this_, uchar param_2, long param_3, long param_4, uchar param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005329D0
uchar add_create(RGE_Victory_Conditions* this_, uchar param_2, long param_3, long param_4, float param_5, float param_6, float param_7, float param_8, uchar param_9) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532A20
uchar add_destroy(RGE_Victory_Conditions* this_, uchar param_2, RGE_Static_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532A50
uchar add_destroy(RGE_Victory_Conditions* this_, uchar param_2, long param_3, long param_4, RGE_Player* param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532A90
uchar add_destroy(RGE_Victory_Conditions* this_, uchar param_2, long param_3, RGE_Player* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532AC0
uchar add_destroy(RGE_Victory_Conditions* this_, uchar param_2, RGE_Player* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532AF0
uchar add_bring(RGE_Victory_Conditions* this_, uchar param_2, RGE_Static_Object* param_3, RGE_Static_Object* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532B30
uchar add_bring(RGE_Victory_Conditions* this_, uchar param_2, RGE_Static_Object* param_3, float param_4, float param_5, float param_6, float param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: unsigned char __thiscall RGE_Victory_Conditions::add_bring(unsigned char,class RGE_Static_... *
    //                              *********************************************************************************************************
...
// Offset: 0x00532B70
uchar add_attributes(RGE_Victory_Conditions* this_, uchar param_2, long param_3, long param_4, uchar param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532BA0
uchar add_explore(RGE_Victory_Conditions* this_, uchar param_2, long param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532BE0
uchar add_victory_points(RGE_Victory_Conditions* this_, uchar param_2, long param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532C10
void sub(RGE_Victory_Conditions* this_, RGE_Victory_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532C50
void destroy_all(RGE_Victory_Conditions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532C70
uchar condition_info(RGE_Victory_Conditions* this_, long param_2, char** param_3, uchar* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532ED0
RGE_Victory_Entry* condition_raw_info(RGE_Victory_Conditions* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532EF0
long condition_number(RGE_Victory_Conditions* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532F00
uchar victory_achieved(RGE_Victory_Conditions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532F10
uchar remove_condition(RGE_Victory_Conditions* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532F50
RGE_Victory_Point_Entry* add_point(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532FA0
void sub_point(RGE_Victory_Conditions* this_, RGE_Victory_Point_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00532FE0
uchar add_points_attribute_amount(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533020
uchar add_points_attribute_first(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533060
uchar add_points_highest_attribute(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005330A0
uchar add_points_high_attribute_once(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005330E0
uchar add_points_high_attribute_amount(RGE_Victory_Conditions* this_, uchar param_2, uchar param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533120
void handle_points_attribute_amount(RGE_Victory_Conditions* this_, RGE_Victory_Point_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533180
void handle_points_attribute_first(RGE_Victory_Conditions* this_, RGE_Victory_Point_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533240
void handle_points_highest_attribute(RGE_Victory_Conditions* this_, RGE_Victory_Point_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533330
void handle_points_high_attribute_once(RGE_Victory_Conditions* this_, RGE_Victory_Point_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533410
void handle_points_high_attribute_amount(RGE_Victory_Conditions* this_, RGE_Victory_Point_Entry* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533480
long get_victory_points(RGE_Victory_Conditions* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00533490
long get_victory_points_group(RGE_Victory_Conditions* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005334C0
long get_victory_points_id(RGE_Victory_Conditions* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005334E0
long get_attribute_id(RGE_Victory_Conditions* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
