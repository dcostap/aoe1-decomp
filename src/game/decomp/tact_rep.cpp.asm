// Auto-generated scaffold unit: tact_rep.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tact_rep.cpp
#include "../include/common.h"

// Offset: 0x004D1680
undefined TRIBE_Action_Repair(TRIBE_Action_Repair* this_, int param_2, RGE_Action_Object* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D1720
undefined TRIBE_Action_Repair(TRIBE_Action_Repair* this_, RGE_Action_Object* param_2, RGE_Task* param_3, RGE_Static_Object* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Repair::TRIBE_Action_Repair(class RGE_Action_Object *,class RGE_Ta... *
    //                              *********************************************************************************************************
    //                              undefined __thiscall TRIBE_Action_Repair(TRIBE_Action_Repair * this,
    //              undefined         <UNASSIGNED>   <RETURN>
    //              TRIBE_Action_R    ECX:4 (auto)   this
...
// Offset: 0x004D17B0
undefined TRIBE_Action_Repair(TRIBE_Action_Repair* this_, RGE_Action_Object* param_2, RGE_Task* param_3, float param_4, float param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Repair::TRIBE_Action_Repair(class RGE_Action_Object *,class RGE_Ta... *
    //                              *********************************************************************************************************
...
undefined FUN_004d1b79() {
    ...
    //                               FUN_004d1b79
    //         004d1b79     NOP
    //         004d1b7a     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_004d18e7::switchdataD_004d1b7c                       XREF[1]:     set_state:004d18e7(*)  
}
...
int TRIBE_Action_Repair::move_to(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall TRIBE_Action_Repair::move_to(class RGE_Static_Object *,float,float,... *
    //                              *********************************************************************************************************
...
int TRIBE_Action_Repair::work(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall TRIBE_Action_Repair::work(class RGE_Static_Object *,float,float,float) *
    //                              *********************************************************************************************************
...
// Offset: 0x004D2020
void meet_target(TRIBE_Action_Repair* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
