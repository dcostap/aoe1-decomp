// Auto-generated scaffold unit: registry.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/registry.cpp
#include "../include/common.h"

// Offset: 0x0047EB80
undefined TRegistry(TRegistry* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047EC00
void TRegistry(TRegistry* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047EC40
int RegSet(TRegistry* this_, int param_2, char* param_3, uchar* param_4, ulong param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047ECA0
int RegSetInt(TRegistry* this_, int param_2, char* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047ED00
int RegSetAscii(TRegistry* this_, int param_2, char* param_3, uchar* param_4, ulong param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047ED60
char* RegGetAscii(TRegistry* this_, int param_2, char* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047EDD0
long RegGet(TRegistry* this_, int param_2, char* param_3, uchar* param_4, ulong* param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0047EE20
int RegGetInt(TRegistry* this_, int param_2, char* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
