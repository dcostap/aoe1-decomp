// Auto-generated scaffold unit: tact_hea.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tact_hea.cpp
#include "../include/common.h"

// Offset: 0x004CE930
undefined TRIBE_Action_Heal(TRIBE_Action_Heal* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CE990
undefined TRIBE_Action_Heal(TRIBE_Action_Heal* this_, RGE_Action_Object* param_2, RGE_Task* param_3, RGE_Static_Object* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CEA10
undefined TRIBE_Action_Heal(TRIBE_Action_Heal* this_, RGE_Action_Object* param_2, RGE_Task* param_3, float param_4, float param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Heal::TRIBE_Action_Heal(class RGE_Action_Object *,class RGE_Task *... *
    //                              *********************************************************************************************************
...
undefined FUN_004cecc6() {
    ...
    //              undefined         <UNASSIGNED>   <RETURN>
    //                               FUN_004cecc6
    //         004cecc6     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_004ceac9::switchdataD_004cecc8                       XREF[1]:     set_state:004ceac9(*)  
}
...
int TRIBE_Action_Heal::work(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall TRIBE_Action_Heal::work(class RGE_Static_Object *,float,float,float)   *
    //                              *********************************************************************************************************
