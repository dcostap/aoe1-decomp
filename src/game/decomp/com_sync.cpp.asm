// Auto-generated scaffold unit: com_sync.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/com_sync.cpp
#include "../include/common.h"

// Offset: 0x00432FF0
undefined RGE_Communications_Synchronize(RGE_Communications_Synchronize* this_, TCommunications_Handler* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433070
void RGE_Communications_Synchronize(RGE_Communications_Synchronize* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004330A0
int Add(RGE_Communications_Synchronize* this_, uint param_2, ulong param_3, ulong param_4, ulong param_5, long param_6, long param_7, long param_8, long param_9, long param_10) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433180
int ValidateChecksums(RGE_Communications_Synchronize* this_, uint param_2, ulong param_3, ulong param_4, ulong param_5, long param_6, long param_7, long param_8, long param_9, long param_10) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433290
ulong DoChecksum(RGE_Communications_Synchronize* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433450
void SetLastWorldRandom(RGE_Communications_Synchronize* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433460
void LogChecksums(RGE_Communications_Synchronize* this_, uint param_2, ulong param_3, ulong param_4, long param_5, long param_6, long param_7, long param_8, long param_9, ulong param_10) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433A90
void EnableSyncChecking(RGE_Communications_Synchronize* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433AA0
void SetStopOnFail(RGE_Communications_Synchronize* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433AB0
void SetDialogOnFail(RGE_Communications_Synchronize* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433AC0
void SendChatMsgsAtChecksum(RGE_Communications_Synchronize* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00433AD0
int IsPlayerOutOfSync(RGE_Communications_Synchronize* this_, uint param_2, ulong param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: int __thiscall RGE_Communications_Synchronize::IsPlayerOutOfSync(unsigned int,unsigned long)  *
    //                              *********************************************************************************************************
