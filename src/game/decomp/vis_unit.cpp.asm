// Auto-generated scaffold unit: vis_unit.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/vis_unit.cpp
#include "../include/common.h"

// Offset: 0x0053B5A0
undefined Visible_Unit_Manager(Visible_Unit_Manager* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053B670
void Visible_Unit_Manager(Visible_Unit_Manager* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053B730
void Build_Distance_Table(Visible_Unit_Manager* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053B7E0
void Update_Unit_Info(Visible_Unit_Manager* this_, int param_2, int param_3, int param_4, int param_5, int param_6, ulong param_7, ulong param_8, VISIBLE_UNIT_REC** param_9) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: void __thiscall Visible_Unit_Manager::Update_Unit_Info(int,int,int,int,int,unsigned long,u... *
    //                              *********************************************************************************************************
...
// Offset: 0x0053BB30
undefined Visible_Resource_Manager(Visible_Resource_Manager* this_, RGE_Player* param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053BBE0
undefined Visible_Resource_Manager(Visible_Resource_Manager* this_, int param_2, RGE_Player* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053BD10
void Visible_Resource_Manager(Visible_Resource_Manager* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053BD70
void save(Visible_Resource_Manager* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053BE00
void Process_New_Tiles(Visible_Resource_Manager* this_, RGE_Tile_List* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053BED0
void AddResource(Visible_Resource_Manager* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053BFD0
int Remove_Resource(Visible_Resource_Manager* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0053C050
VISIBLE_RESOURCE_REC* Get_Closest_Resource(Visible_Resource_Manager* this_, int param_2, int param_3, int param_4, int param_5, int* param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: struct VISIBLE_RESOURCE_REC * __thiscall Visible_Resource_Manager::Get_Closest_Resource(in... *
    //                              *********************************************************************************************************
