// Auto-generated scaffold unit: bucket_0506.asm
#include "../include/common.h"

// Offset: 0x00506310
void TribeTradeShipUnitAIModule(TribeTradeShipUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005068A0
void TribeTransportShipUnitAIModule(TribeTransportShipUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00506C60
void TribeFishingShipUnitAIModule(TribeFishingShipUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
