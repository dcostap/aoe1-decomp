// Auto-generated scaffold unit: tpnl_tml.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tpnl_tml.cpp
#include "../include/common.h"

// Offset: 0x0051E650
undefined Time_Line_Panel(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051E790
void Time_Line_Panel(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051E860
long create_timeline(Time_Line_Panel* this_, TPanel* param_2, Time_Line_Panel** param_3, long param_4, long param_5, long param_6, long param_7, long param_8, long param_9, long param_10, long param_11) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051E9E0
long setup(Time_Line_Panel* this_, TDrawArea* param_2, TPanel* param_3, long param_4, long param_5, long param_6, long param_7, void* param_8, long param_9, long param_10, void* param_11, long param_12, long param_13, char* param_14, char* param_15, int param_16, uchar param_17, int param_18, uchar param_19) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: long __thiscall Time_Line_Panel::setup(class TDrawArea *,class TPanel *,long,long,long,lon... *
    //                              *********************************************************************************************************
...
// Offset: 0x0051EAB0
void set_bevel_info(Time_Line_Panel* this_, int param_2, int param_3, int param_4, int param_5, int param_6, int param_7, int param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051EB00
int set_background(Time_Line_Panel* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051EC10
int set_background(Time_Line_Panel* this_, char* param_2, long param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051EDD0
int set_special_events(Time_Line_Panel* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051EEE0
int set_special_events(Time_Line_Panel* this_, char* param_2, long param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051F0A0
void set_axis_font(Time_Line_Panel* this_, void* param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051F0D0
void set_body_font(Time_Line_Panel* this_, void* param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051F100
void set_back_color(Time_Line_Panel* this_, int param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051F120
void draw_border(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_0051f2e5() {
    ...
    //                               FUN_0051f2e5
    //         0051f2e5     NOP
    //         0051f2e6     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_0051f158::switchdataD_0051f2e8                       XREF[1]:     draw_border:0051f158(*)  
}

// Offset: 0x0051F310
void init_timeline(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051F4E0
void add_pop_total_special_event(Time_Line_Panel* this_, long param_2, long param_3, long param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051F560
void record_special_event(Time_Line_Panel* this_, uchar param_2, TRIBE_History_Info* param_3, uchar param_4, long param_5, long param_6, long param_7, long param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: void __thiscall Time_Line_Panel::record_special_event(unsigned char,class TRIBE_History_In... *
    //                              *********************************************************************************************************
...
// Offset: 0x0051F600
int calculate_icon_location(Time_Line_Panel* this_, Special_Events* param_2, short param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: int __thiscall Time_Line_Panel::calculate_icon_location(struct Special_Events *,short,unsi... *
    //                              *********************************************************************************************************
...
// Offset: 0x0051FA90
void draw_axis(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0051FD90
void draw_special_events(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_00520032() {
    ...
    //              undefined         <UNASSIGNED>   <RETURN>
    //                               FUN_00520032
    //         00520032     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_0051fdef::switchdataD_00520034                       XREF[1]:     draw_special_events:0051fdef(*)  
}

// Offset: 0x00520080
void draw_background(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00520220
void draw_civilization_names(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005204A0
void draw_timeline(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_00520abd() {
    ...
    //                               FUN_00520abd
    //         00520abd     NOP
    //         00520abe     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_005207da::switchdataD_00520ac0                       XREF[1]:     draw_timeline:005207da(*)  
}

// Offset: 0x00520AE0
void draw_icon(Time_Line_Panel* this_, Special_Events* param_2, short param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_00520d25() {
    ...
    //                               FUN_00520d25
    //         00520d25     NOP
    //         00520d26     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_00520b22::switchdataD_00520d28                       XREF[1]:     draw_icon:00520b22(*)  
}

// Offset: 0x00520D50
void draw_legend(Time_Line_Panel* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
