// Auto-generated scaffold unit: taiconmd.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/taiconmd.cpp
#include "../include/common.h"

// Offset: 0x004D5E60
undefined TribeConstructionAIModule(TribeConstructionAIModule* this_, void* param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D5EB0
undefined TribeConstructionAIModule(TribeConstructionAIModule* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D5EE0
void TribeConstructionAIModule(TribeConstructionAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D5EF0
void setMainDecisionAI(TribeConstructionAIModule* this_, TribeMainDecisionAIModule* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: void __thiscall TribeConstructionAIModule::setMainDecisionAI(class TribeMainDecisionAIModu... *
    //                              *********************************************************************************************************
...
// Offset: 0x004D5F00
int canPlace(TribeConstructionAIModule* this_, BuildItem* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D60E0
ConstructionItem* placeStructure(TribeConstructionAIModule* this_, BuildItem* param_2, int param_3, PlacementState* param_4, ulong param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: class ConstructionItem * __thiscall TribeConstructionAIModule::placeStructure(class BuildI... *
    //                              *********************************************************************************************************
...
// Offset: 0x004D6780
ConstructionItem* placeDock(TribeConstructionAIModule* this_, BuildItem* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D6800
void setBuilt(TribeConstructionAIModule* this_, RGE_Static_Object* param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D68A0
ConstructionItem* compare(TribeConstructionAIModule* this_, ConstructionItem* param_2, ConstructionItem* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: class ConstructionItem * __thiscall TribeConstructionAIModule::compare(class Constructi... *
    //                              *********************************************************************************************************
