// Auto-generated scaffold unit: bucket_0504.asm
#include "../include/common.h"

// Offset: 0x00504090
void TribePreditorUnitAIModule(TribePreditorUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005041B0
void TribeElephantUnitAIModule(TribeElephantUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00504460
void TribeLionUnitAIModule(TribeLionUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00504740
void TribeRangedUnitAIModule(TribeRangedUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005048C0
void TribeRangedUnitAIModule2(TribeRangedUnitAIModule2* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00504C80
void TribeCivilianUnitAIModule(TribeCivilianUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
