// Auto-generated scaffold unit: tscenaro.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tscenaro.cpp
#include "../include/common.h"

// Offset: 0x0052A990
undefined TRIBE_Scenario_Header(TRIBE_Scenario_Header* this_, T_Scenario* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052A9F0
undefined TRIBE_Scenario_Header(TRIBE_Scenario_Header* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052AAC0
undefined T_Scenario(T_Scenario* this_, RGE_Game_World* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052AB90
undefined T_Scenario(T_Scenario* this_, int param_2, RGE_Game_World* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B080
void InitializePlayerValues(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B100
void ClearDisabledTechnologies(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B120
void InitializeAIInformation(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B170
void Set_victory_all_flag(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B190
int Get_victory_all_flag(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B1A0
void SetMPVictory(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B1C0
int GetMPVictory(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B1D0
void SetVictoryScore(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B1E0
int GetVictoryScore(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B1F0
void SetVictoryTime(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B200
int GetVictoryTime(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B210
void SetSPWhich(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B230
int GetSPWhich(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B240
void InitializeVictoryValues(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B280
void ClearSPVictoryCondition(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B2B0
void InitializeFriendlinessValues(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B2D0
void Set_player_attitude(T_Scenario* this_, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B310
int Get_player_attitude(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B340
void Set_player_Gold(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B360
void Set_player_Wood(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B380
void Set_player_Food(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B3A0
void Set_player_Stone(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B3C0
void Set_player_Info(T_Scenario* this_, int param_2, Player_Start_Info* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B400
void Set_Multi_Conquest(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B430
void Set_Multi_Ruins(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B440
void Set_Multi_Artifacts(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B450
void Set_Multi_Discoveries(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B460
void Set_Multi_Exploration(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B470
void Set_Multi_Gold(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B480
void SetSPRectangle(T_Scenario* this_, int param_2, float param_3, float param_4, float param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B500
void SetSPObjectType(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B530
void SetSPPlayerID(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B560
void SetSPAllFlag(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B590
void SetSPAttribType(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B5C0
void SetSPVictoryType(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B5F0
void SetSPObject(T_Scenario* this_, int param_2, RGE_Static_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B630
void SetSPDestObjectID(T_Scenario* this_, int param_2, RGE_Static_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B670
void SetSPAmount(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B6A0
void SetPlayerAlliedVictory(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B6C0
void SetDisabledTechnology(T_Scenario* this_, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B6E0
void SetScenarioOption(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B700
void SetPlayerAge(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B720
int Get_player_Gold(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B740
int Get_player_Wood(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B760
int Get_player_Food(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B780
int Get_player_Stone(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B7A0
Player_Start_Info* Get_player_Info(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B7C0
int Get_Multi_Conquest(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B7D0
int Get_Multi_Ruins(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B7E0
int Get_Multi_Artifacts(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B7F0
int Get_Multi_Discoveries(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B800
int Get_Multi_Exploration(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B810
int Get_Multi_Gold(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B820
void GetSPRectangle(T_Scenario* this_, int param_2, float* param_3, float* param_4, float* param_5, float* param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B8B0
int GetSPObjectType(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B8E0
int GetSPPlayerID(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B910
int GetSPAllFlag(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B940
int GetSPAttribType(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B970
int GetSPAmount(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B9A0
int GetSPVictoryType(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052B9D0
RGE_Static_Object* GetSPDestObjectID(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BA00
RGE_Static_Object* GetSPObject(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BA30
int GetPlayerAlliedVictory(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BA40
int GetDisabledTechnology(T_Scenario* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BA60
int GetScenarioOption(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BA70
int GetPlayerAge(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BA90
void SaveAttributesIntoPlayers(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052BBC0
void Save_victory_conditions_into_players(T_Scenario* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052C0A0
int get_object_ID(T_Scenario* this_, RGE_Static_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052C0B0
void WriteDisabledTechnologiesToMainSystem(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052C1E0
int any_sp_victory(T_Scenario* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0052C230
void set_player_tech(T_Scenario* this_, TRIBE_Player* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
