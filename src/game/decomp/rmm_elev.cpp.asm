// Auto-generated scaffold unit: rmm_elev.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/rmm_elev.cpp
#include "../include/common.h"

// Offset: 0x004846C0
undefined RGE_RMM_Elevation_Generator(RGE_RMM_Elevation_Generator* this_, RGE_Map* param_2, RGE_Random_Map_Module* param_3, RGE_Elevation_Info* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall RGE_RMM_Elevation_Generator::RGE_RMM_Elevation_Generator(class RGE_Map *,class ... *
    //                              *********************************************************************************************************
    //                              undefined __thiscall RGE_RMM_Elevation_Generator(RGE_RMM_Elevation_G
    //              undefined         <UNASSIGNED>   <RETURN>
    //              RGE_RMM_Elevat    ECX:4 (auto)   this
    //              RGE_Map *         Stack[0x4]:4   param_1                   XREF[1]:     004846c8(R)  
    //              RGE_Random_Map    Stack[0x8]:4   param_2                   XREF[1]:     004846c0(R)  
    //              RGE_Elevation_    Stack[0xc]:4   param_3                   XREF[1]:     004846d8(R)  
    //                               ??0RGE_RMM_Elevation_Generator@@QAE@PAVRGE_Map@@PAVRGE_Rand  XREF[1]:     generate:00483517(c)  
    //                               RGE_RMM_Elevation_Generator::RGE_RMM_Elevation_Generator
    //                              rmm_elev.cpp:21 (24)
    //         004846c0     MOV        EAX,dword ptr [ESP + param_2]
    //         004846c4     PUSH       EBX
    //         004846c5     PUSH       ESI
    //         004846c6     MOV        EBX,this
    //         004846c8     MOV        this,dword ptr [ESP + param_1]
    //         004846cc     PUSH       EDI
    //         004846cd     PUSH       0x1
    //         004846cf     PUSH       EAX
    //         004846d0     PUSH       this
    //         004846d1     MOV        this,EBX
    //         004846d3     CALL       RGE_Random_Map_Module::RGE_Random_Map_Module     undefined RGE_Random_Map_Module(RGE_Random_Ma
    //                              rmm_elev.cpp:22 (20)
    //         004846d8     MOV        ESI,dword ptr [ESP + param_3]
    //         004846dc     LEA        EDI,[EBX + 0x30]
    //         004846df     MOV        this,0x3e0
    //         004846e4     MOV        dword ptr [EBX],RGE_RMM_Elevation_Generator::`   = 00484700
    //         004846ea     MOVSD.REP  ES:EDI,ESI
    //                              rmm_elev.cpp:25 (15)
    //         004846ec     POP        EDI
    //         004846ed     MOV        dword ptr [EBX + 0x1c],0x3fc00000
    //         004846f4     MOV        EAX,EBX
    //         004846f6     POP        ESI
    //         004846f7     POP        EBX
    //         004846f8     RET        0xc
}
...
// Offset: 0x004847C0
uchar check_start_elevation(RGE_RMM_Elevation_Generator* this_, long param_2, long param_3, uchar param_4, uchar param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004848A0
uchar check_elevation(RGE_RMM_Elevation_Generator* this_, uchar param_2, long param_3, long param_4, long param_5, uchar param_6, uchar param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00484A40
void generate_modifiers(RGE_RMM_Elevation_Generator* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00484B30
float fig_chance(RGE_RMM_Elevation_Generator* this_, long param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00484B50
long count_map_tiles(RGE_RMM_Elevation_Generator* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00484B90
void link_stack_randomly(RGE_RMM_Elevation_Generator* this_, Map_Stack* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00484C80
void remove_area_from_lists(RGE_RMM_Elevation_Generator* this_, long param_2, long param_3, long param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00484D00
uchar base_elevation_generate(RGE_RMM_Elevation_Generator* this_, RGE_Elevation_Info_Line param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
