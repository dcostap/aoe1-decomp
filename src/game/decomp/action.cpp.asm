// Auto-generated scaffold unit: action.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/action.cpp
#include "../include/common.h"

// Offset: 0x00401130
RGE_Static_Object* TRIBE_Action_Heal::get_target_obj() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00401140
RGE_Static_Object* TRIBE_Action_Heal::get_target_obj2() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407460
undefined RGE_Action(RGE_Action* this_, int param_2, RGE_Action_Object* param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004074C0
undefined RGE_Action(RGE_Action* this_, RGE_Action_Object* param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004074F0
void RGE_Action(RGE_Action* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004076D0
RGE_Action_List* TRIBE_Action_Heal::create_action_list(RGE_Action_Object* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual class RGE_Action_List * __thiscall RGE_Action::create_action_list(class RGE_Action... *
    //                              *********************************************************************************************************
...
// Offset: 0x00407790
void TRIBE_Action_Heal::save(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004078E0
void TRIBE_Action::first_in_stack(uchar param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407900
int TRIBE_Action_Heal::move_to(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407910
int RGE_Action_Make::work(RGE_Static_Object* param_1, float param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407920
uchar TRIBE_Action_Heal::attack_response(RGE_Static_Object* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407930
uchar TRIBE_Action_Heal::relation_response(long param_1, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407940
void TRIBE_Action::set_state(uchar param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407950
uchar TRIBE_Action_Heal::inside_obj_update() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407990
uchar TRIBE_Action_Heal::idle_update() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407A20
void TRIBE_Action_Heal::set_target_obj(RGE_Static_Object* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407A90
void TRIBE_Action_Heal::set_target_obj2(RGE_Static_Object* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407B00
void TRIBE_Action_Heal::copy_obj(RGE_Master_Action_Object* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407C00
void TRIBE_Action_Heal::copy_obj_sprites(RGE_Master_Action_Object* param_1, RGE_Task* param_2, RGE_Task* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual void __thiscall RGE_Action::copy_obj_sprites(class RGE_Master_Action_Object *,clas... *
    //                              *********************************************************************************************************
...
// Offset: 0x00407C10
void TRIBE_Action_Heal::get_state_name(char* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407D30
float targetX(RGE_Action* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407D40
float targetY(RGE_Action* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407D50
float targetZ(RGE_Action* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407D60
uchar subAction(RGE_Action* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407D70
void setSubAction(RGE_Action* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
