// Auto-generated scaffold unit: tact_dar.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tact_dar.cpp
#include "../include/common.h"

// Offset: 0x004CE530
undefined TRIBE_Action_Discovery_Artifact(TRIBE_Action_Discovery_Artifact* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CE5F0
undefined TRIBE_Action_Discovery_Artifact(TRIBE_Action_Discovery_Artifact* this_, RGE_Action_Object* param_2, RGE_Task* param_3, RGE_Static_Object* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004CE670
undefined TRIBE_Action_Discovery_Artifact(TRIBE_Action_Discovery_Artifact* this_, RGE_Action_Object* param_2, RGE_Task* param_3, float param_4, float param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Discovery_Artifact::TRIBE_Action_Discovery_Artifact(class RGE_Acti... *
    //                              *********************************************************************************************************
...
// Offset: 0x004CE7A0
void check_objects(TRIBE_Action_Discovery_Artifact* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
