// Auto-generated scaffold unit: taicrule.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/taicrule.cpp
#include "../include/common.h"

// Offset: 0x004D68D0
undefined CombatRuleSystem(CombatRuleSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D6900
void CombatRuleSystem(CombatRuleSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D6910
int loadRules(CombatRuleSystem* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D6AA0
int bestUnitTypeToAttack(CombatRuleSystem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D6AB0
int bestUnitTypeToDefendAgainst(CombatRuleSystem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
