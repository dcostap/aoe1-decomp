// Auto-generated scaffold unit: pathsys.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/pathsys.cpp
...
// Offset: 0x0046B0F0
undefined PathingSystem(PathingSystem* this_, int param_2, int param_3, int param_4, RGE_Map* param_5, RGE_Game_World* param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B270
void PathingSystem(PathingSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B310
int initialize(PathingSystem* this_, int param_2, int param_3, RGE_Map* param_4, RGE_Game_World* param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B360
void printToFile(PathingSystem* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B550
uchar lookupMisc(PathingSystem* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B570
void setMisc(PathingSystem* this_, int param_2, int param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B590
void initMisc(PathingSystem* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B5C0
void zeroObstructionMap(PathingSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B5E0
uchar obstruction(PathingSystem* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B620
void incrementObstruction(PathingSystem* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B680
void decrementObstruction(PathingSystem* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046B6E0
int findTilePath(PathingSystem* this_, int param_2, int param_3, int param_4, int param_5, RGE_Moving_Object* param_6, float param_7, int param_8, int param_9, float* param_10, int param_11, int param_12, int param_13, int param_14, int param_15, int param_16) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D250
void incrementInitialPaths(PathingSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D260
void incrementContinuePaths(PathingSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D270
void incrementCanPaths(PathingSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D280
int passable(PathingSystem* this_, RGE_Moving_Object* param_2, float param_3, float param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D740
long checksum(PathingSystem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D770
void printState(PathingSystem* this_, RGE_Moving_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046D830
int copyPath(PathingSystem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0046DCB0
void copyUnobstructibles(PathingSystem* this_, ManagedArray<int>* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
