// Auto-generated scaffold unit: tact_tek.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tact_tek.cpp
#include "../include/common.h"

// Offset: 0x004D21B0
undefined TRIBE_Action_Make_Tech(TRIBE_Action_Make_Tech* this_, int param_2, RGE_Action_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D2250
undefined TRIBE_Action_Make_Tech(TRIBE_Action_Make_Tech* this_, RGE_Action_Object* param_2, short param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Action_Make_Tech::TRIBE_Action_Make_Tech(class RGE_Action_Object *,short,... *
    //                              *********************************************************************************************************
    //                              undefined __thiscall TRIBE_Action_Make_Tech(TRIBE_Action_Make_Tech *
    //              undefined         <UNASSIGNED>   <RETURN>
    //              TRIBE_Action_M    ECX:4 (auto)   this
...
// Offset: 0x004D2290
void TRIBE_Action_Make_Tech(TRIBE_Action_Make_Tech* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004D25E0
void get_info(TRIBE_Action_Make_Tech* this_, short* param_2, short* param_3, char* param_4, short param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
