// Auto-generated scaffold unit: m_ac_obj.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/m_ac_obj.cpp
#include "../include/common.h"

// Offset: 0x0044F070
undefined RGE_Master_Action_Object(RGE_Master_Action_Object* this_, RGE_Master_Action_Object* param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F0F0
undefined RGE_Master_Action_Object(RGE_Master_Action_Object* this_, int param_2, RGE_Sprite** param_3, RGE_Sound** param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F160
undefined RGE_Master_Action_Object(RGE_Master_Action_Object* this_, FILE* param_2, RGE_Sprite** param_3, RGE_Sound** param_4, short param_5, int param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F1E0
int setup(RGE_Master_Action_Object* this_, RGE_Master_Action_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F290
int setup(RGE_Master_Action_Object* this_, int param_2, RGE_Sprite** param_3, RGE_Sound** param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: int __thiscall RGE_Master_Action_Object::setup(int,class RGE_Sprite * *,class RGE_Sound... *
    //                              *********************************************************************************************************
...
// Offset: 0x0044F3C0
int setup(RGE_Master_Action_Object* this_, FILE* param_2, RGE_Sprite** param_3, RGE_Sound** param_4, short param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: int __thiscall RGE_Master_Action_Object::setup(struct _iobuf *,class RGE_Sprite * *,cla... *
    //                              *********************************************************************************************************
...
// Offset: 0x0044F4D0
void RGE_Master_Action_Object(RGE_Master_Action_Object* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F540
RGE_Task_List* RGE_Master_Combat_Object::create_task_list() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
RGE_Master_Static_Object* RGE_Master_Action_Object::make_new_master() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual class RGE_Master_Static_Object * __thiscall RGE_Master_Action_Object::make_new_mas... *
    //                              *********************************************************************************************************
    //                              RGE_Master_Static_Object * __thiscall make_new_master(RGE_Master_Act
    //              RGE_Master_Sta    EAX:4          <RETURN>
    //              RGE_Master_Act    ECX:4 (auto)   this
    //              undefined4        Stack[-0x4]:4  local_4                   XREF[1]:     0044f69c(W)  
    //              undefined4        Stack[-0xc]:4  local_c                   XREF[2]:     0044f6b0(R), 0044f6c0(R)  
    //              undefined4        Stack[-0x10]:4 local_10                  XREF[1]:     0044f696(W)  
    //                               ?make_new_master@RGE_Master_Action_Object@@UAEPAVRGE_Master  XREF[1]:     00570464(*)  
    //                               RGE_Master_Action_Object::make_new_master
    //                              m_ac_obj.cpp:207 (25)
    //         0044f670     PUSH       -0x1
    //         0044f672     PUSH       FUN_0055d6fb
    //         0044f677     MOV        EAX,FS:[0x0]
    //         0044f67d     PUSH       EAX
    //         0044f67e     MOV        dword ptr FS:[0x0],ESP
    //         0044f685     PUSH       this
    //         0044f686     PUSH       ESI
    //         0044f687     MOV        ESI,this
    //                              m_ac_obj.cpp:208 (39)
    //         0044f689     PUSH       0xfc
    //         0044f68e     CALL       operator_new                                     void * operator_new(uint param_1)
    //         0044f693     ADD        ESP,0x4
    //         0044f696     MOV        dword ptr [ESP + local_10],EAX
    //         0044f69a     TEST       EAX,EAX
    //         0044f69c     MOV        dword ptr [ESP + local_4],0x0
    //         0044f6a4     JZ         LAB_0044f6c0
    //         0044f6a6     PUSH       0x1
    //         0044f6a8     PUSH       ESI
    //         0044f6a9     MOV        this,EAX
    //         0044f6ab     CALL       RGE_Master_Action_Object::RGE_Master_Action_Ob   undefined RGE_Master_Action_Object(RGE_Master
    //                              m_ac_obj.cpp:209 (34)
    //         0044f6b0     MOV        this,dword ptr [ESP + local_c]
    //         0044f6b4     MOV        dword ptr FS:[0x0],this
    //         0044f6bb     POP        ESI
    //         0044f6bc     ADD        ESP,0x10
    //         0044f6bf     RET
    //                               LAB_0044f6c0                                                 XREF[1]:     0044f6a4(j)  
    //         0044f6c0     MOV        this,dword ptr [ESP + local_c]
    //         0044f6c4     XOR        EAX,EAX
    //         0044f6c6     MOV        dword ptr FS:[0x0],this
    //         0044f6cd     POP        ESI
    //         0044f6ce     ADD        ESP,0x10
    //         0044f6d1     RET
}

// Offset: 0x0044F6E0
RGE_Task* get_task(RGE_Master_Action_Object* this_, short param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044F710
RGE_Task* getTaskByTaskID(RGE_Master_Action_Object* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
