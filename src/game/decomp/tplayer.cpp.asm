// Auto-generated scaffold unit: tplayer.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tplayer.cpp
#include "../include/common.h"

// Offset: 0x00511BD0
undefined TRIBE_Player(TRIBE_Player* this_, int param_2, TRIBE_World* param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00511E20
undefined TRIBE_Player(TRIBE_Player* this_, TRIBE_World* param_2, RGE_Master_Player* param_3, uchar param_4, char* param_5, uchar param_6, uchar param_7, uchar param_8, char* param_9, char* param_10, char* param_11) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Player::TRIBE_Player(class TRIBE_World *,class RGE_Master_Player *,unsign... *
    //                              *********************************************************************************************************
...
// Offset: 0x005120F0
void TRIBE_Player(TRIBE_Player* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005121A0
RGE_Static_Object* TRIBE_Gaia::make_scenario_obj(float param_1, float param_2, float param_3, short param_4, uchar param_5, float param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual class RGE_Static_Object * __thiscall TRIBE_Player::make_scenario_obj(float,float,f... *
    //                              *********************************************************************************************************
...
// Offset: 0x00512620
void TRIBE_Gaia::update_dopplegangers() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00512630
void TRIBE_Gaia::scenario_save(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00512690
void TRIBE_Gaia::scenario_load(int param_1, long* param_2, float param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005128A0
void TRIBE_Gaia::load(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00512A90
void load_master_object(TRIBE_Player* this_, int param_2, short param_3, uchar param_4, RGE_Sprite** param_5, RGE_Sound** param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00512BF0
void tech_cost(TRIBE_Player* this_, short param_2, short* param_3, short* param_4, short* param_5, short* param_6, short* param_7, short* param_8) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: void __thiscall TRIBE_Player::tech_cost(short,short &,short &,short &,short &,short &,shor... *
    //                              *********************************************************************************************************
...
// Offset: 0x00512C30
void obj_cost(TRIBE_Player* this_, short param_2, char** param_3, short* param_4, short* param_5, short* param_6, short* param_7, short* param_8, short* param_9, float param_10) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: void __thiscall TRIBE_Player::obj_cost(short,char * *,short &,short &,short &,short &,shor... *
    //                              *********************************************************************************************************
...
// Offset: 0x00512EC0
RGE_Static_Object* find_obj(TRIBE_Player* this_, short param_2, RGE_Static_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00512F60
RGE_Static_Object* TRIBE_Gaia::make_new_object(long param_1, float param_2, float param_3, float param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual class RGE_Static_Object * __thiscall TRIBE_Player::make_new_object(long,float,floa... *
    //                              *********************************************************************************************************
...
// Offset: 0x00513000
void interface_tech_avail(TRIBE_Player* this_, Item_Avail** param_2, short* param_3, short param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005131C0
void interface_item_avail(TRIBE_Player* this_, Item_Avail** param_2, short* param_3, short param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005134F0
void interface_trade_avail(TRIBE_Player* this_, Trade_Avail** param_2, short* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513600
uchar command_make_building(TRIBE_Player* this_, short param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513690
uchar command_make_wall(TRIBE_Player* this_, short param_2, long param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513720
uchar command_building_make_tech(TRIBE_Player* this_, short param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513750
uchar command_building_cancel(TRIBE_Player* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513790
uchar command_delete_object(TRIBE_Player* this_, RGE_Static_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005137D0
uchar command_trade_attribute(TRIBE_Player* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513840
uchar command_trade_attribute(TRIBE_Player* this_, int param_2, long param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513860
uchar command_attack_ground(TRIBE_Player* this_, float param_2, float param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005138D0
uchar TRIBE_Gaia::command_give_attribute(int param_1, int param_2, float param_3, float param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual unsigned char __thiscall TRIBE_Player::command_give_attribute(int,int,float,float)    *
    //                              *********************************************************************************************************
...
// Offset: 0x00513920
uchar command_building_make_obj(TRIBE_Player* this_, short param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513950
uchar command_make_repair(TRIBE_Player* this_, RGE_Static_Object* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513A80
uchar command_make_unload(TRIBE_Player* this_, float param_2, float param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513AF0
uchar check_obj_cost(TRIBE_Player* this_, short param_2, short* param_3, float param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513C50
uchar pay_obj_cost(TRIBE_Player* this_, short param_2, float param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513D00
void reimburse_obj_cost(TRIBE_Player* this_, short param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513D60
uchar check_tech_cost(TRIBE_Player* this_, short param_2, short* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513D80
uchar pay_tech_cost(TRIBE_Player* this_, short param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513DA0
void tech_abling(TRIBE_Player* this_, long param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00513DD0
void rev_tech(TRIBE_Player* this_, long param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_00513f95() {
    ...
    //                               FUN_00513f95
    //         00513f95     NOP
    //         00513f96     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_00513de9::switchdataD_00513f98                       XREF[1]:     rev_tech:00513de9(*)  
}

// Offset: 0x00513FD0
void add_population_entry(TRIBE_Player* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514510
void objectCost(TRIBE_Player* this_, int param_2, int param_3, ResourceItem* param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514590
int TRIBE_Gaia::objectCostByType(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005145E0
void researchCost(TRIBE_Player* this_, int param_2, int param_3, ResourceItem* param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514660
int objectAvailable(TRIBE_Player* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514690
int researchAvailable(TRIBE_Player* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005146B0
int researchEverAvailable(TRIBE_Player* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005146E0
uchar researchState(TRIBE_Player* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514720
char* TRIBE_Gaia::aiStatus(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514F90
void TRIBE_Gaia::kickAI(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514FB0
int TRIBE_Gaia::strategicNumber(int param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00514FE0
void TRIBE_Gaia::logMessage(char* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515040
int TRIBE_Gaia::sendAICommand(int param_1, int param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515070
RGE_Object_Node* TRIBE_Gaia::addObject(RGE_Static_Object* param_1, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual struct RGE_Object_Node * __thiscall TRIBE_Player::addObject(class RGE_Static_Objec... *
    //                              *********************************************************************************************************
...
// Offset: 0x005150E0
void TRIBE_Gaia::removeObject(RGE_Static_Object* param_1, int param_2, int param_3, RGE_Object_Node* param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual void __thiscall TRIBE_Player::removeObject(class RGE_Static_Object *,int,int,struc... *
    //                              *********************************************************************************************************
...
// Offset: 0x00515130
void TRIBE_Gaia::buildObject(int param_1, int param_2, float param_3, float param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515180
void TRIBE_Gaia::cancelBuild(int param_1, int param_2, int param_3, float param_4, float param_5, int param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005151C0
void TRIBE_Gaia::registerBuild(RGE_Static_Object* param_1, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005151F0
void TRIBE_Gaia::trainUnit(int param_1, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515220
void TRIBE_Gaia::cancelTrain(int param_1, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515250
void TRIBE_Gaia::registerTrain(int param_1, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515280
void TRIBE_Gaia::research(int param_1, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005152B0
void TRIBE_Gaia::cancelResearch(int param_1, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005152E0
void TRIBE_Gaia::registerResearch(int param_1, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515310
void TRIBE_Gaia::taskTrader(int param_1, int param_2, int param_3, float param_4, float param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515360
void TRIBE_Gaia::taskResourceGatherer(int param_1, int param_2, int param_3, float param_4, float param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005153B0
void TRIBE_Gaia::setDiplomaticStance(int param_1, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005153D0
void TRIBE_Gaia::loadAIInformation(char* param_1, char* param_2, char* param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_005159ba() {
    ...
    //              undefined         <UNASSIGNED>   <RETURN>
    //                               FUN_005159ba
    //         005159ba     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_00515428::switchdataD_005159bc                       XREF[1]:     loadAIInformation:00515428(*)  
}

// Offset: 0x005159D0
void TRIBE_Gaia::notify(int param_1, int param_2, int param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515BB0
void TRIBE_Gaia::notifyAI(int param_1, int param_2, int param_3, long param_4, long param_5, long param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515DF0
int intelligentCivSelection(TRIBE_Player* this_, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00515E00
void intelligentBuildListAndRulesSelection(TRIBE_Player* this_, char* param_2, char* param_3, int param_4, int param_5, int param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: void __thiscall TRIBE_Player::intelligentBuildListAndRulesSelection(char *,char *,int,int,... *
    //                              *********************************************************************************************************
...
// Offset: 0x00517B90
void setupEgyptian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00517CD0
void setupGreek(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00517E10
void setupBabylonian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00517F30
void setupAssyrian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518090
void setupMinoan(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005181C0
void setupHittite(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005182E0
void setupPhoenician(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518400
void setupSumerian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518540
void setupPersian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518670
void setupShang(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005187A0
void setupYamato(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005188F0
void setupChoson(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518A20
void setupRoman(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518B50
void setupCarthaginian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518C90
void setupPalmyran(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518DD0
void setupMacedonian(TRIBE_Player* this_, int* param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00518F00
void TRIBE_Gaia::logStatus(FILE* param_1, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005192F0
void TRIBE_Gaia::trackUnitGather(int param_1, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00519320
void get_achievement(TRIBE_Player* this_, uchar param_2, char* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_00519465() {
    ...
    //                               FUN_00519465
    //         00519465     NOP
    //         00519466     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_00519334::switchdataD_00519468                       XREF[1]:     get_achievement:00519334(*)  
}

// Offset: 0x00519490
void TRIBE_Gaia::load_victory(int param_1, long* param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00519570
void TRIBE_Gaia::add_attribute_num(short param_1, float param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005195D0
void TRIBE_Gaia::analyize_selected_objects() {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005196E0
int TRIBE_Gaia::get_mouse_pointer_action_vars(int param_1, int* param_2, int* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
undefined FUN_00519ab2() {
    ...
    //                               FUN_00519ab2
    //                              tplayer.cpp:5248 (62)
    //         00519ab2     MOV        EDI,EDI
    //                              Symbol Ref: No symbol: NONAME
    //                               switchD_00519859::switchdataD_00519ab4                       XREF[1]:     get_mouse_pointer_action_vars:0051
}

// Offset: 0x00519AF0
undefined TRIBE_Gaia(TRIBE_Gaia* this_, int param_2, TRIBE_World* param_3, uchar param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00519BD0
undefined TRIBE_Gaia(TRIBE_Gaia* this_, TRIBE_World* param_2, RGE_Master_Player* param_3, uchar param_4, char* param_5, uchar param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall TRIBE_Gaia::TRIBE_Gaia(class TRIBE_World *,class RGE_Master_Player *,unsigned c... *
    //                              *********************************************************************************************************
...
// Offset: 0x00519D10
void load_master_object(TRIBE_Gaia* this_, int param_2, short param_3, uchar param_4, RGE_Sprite** param_5, RGE_Sound** param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
