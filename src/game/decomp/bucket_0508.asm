// Auto-generated scaffold unit: bucket_0508.asm
#include "../include/common.h"

// Offset: 0x00508100
void TribeTowerUnitAIModule(TribeTowerUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00508310
void TribeBuildingUnitAIModule(TribeBuildingUnitAIModule* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
