// Auto-generated scaffold unit: world.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/World.cpp
#include "../include/common.h"

// Offset: 0x00540750
undefined RGE_Game_World(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00540A40
void RGE_Game_World(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00540CF0
void reset_object_count(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00540D60
void set_map_visible(RGE_Game_World* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00540D80
void set_map_fog(RGE_Game_World* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
uchar RGE_Game_World::init_player_type(int param_1, short param_2, uchar param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: virtual unsigned char __thiscall RGE_Game_World::init_player_type(int,short,unsigned char) *
    //                              *********************************************************************************************************
...
// Offset: 0x00541EA0
void reset_communications(RGE_Game_World* this_, TCommunications_Handler* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00541EB0
void reset_player_visible_maps(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00542470
void set_game_speed(RGE_Game_World* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
uchar RGE_Game_World::new_scenario(RGE_Player_Info* param_1, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual unsigned char __thiscall RGE_Game_World::new_scenario(struct RGE_Player_Info &,int)   *
    //                              *********************************************************************************************************
...
uchar RGE_Game_World::new_random_game(RGE_Player_Info* param_1) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: virtual unsigned char __thiscall RGE_Game_World::new_random_game(struct RGE_Player_Info &) *
    //                              *********************************************************************************************************
...
// Offset: 0x00542E50
void update_sounds(RGE_Game_World* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00542E90
void update_sprites(RGE_Game_World* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00543380
int is_player_turn(RGE_Game_World* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x005433A0
ulong get_accum_time_delta(RGE_Game_World* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545B30
void selectNextComputerPlayer(RGE_Game_World* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545BC0
void useComputerPlayerUpdateTime(RGE_Game_World* this_, ulong param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545BF0
int computerPlayerUpdateTimeAvailable(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545C00
int objectGroupOnTile(RGE_Game_World* this_, int param_2, int param_3, int param_4, int param_5, int* param_6) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545CB0
int difficultyLevel(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545CF0
int maxNumberObjects(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545D00
int maxNumberNegativeObjects(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545D10
int numberObjects(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545D20
int numberNegativeObjects(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545D30
RGE_Static_Object* object(RGE_Game_World* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545D80
RGE_Static_Object* object_ptr(RGE_Game_World* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545D90
long get_next_object_id(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00545DD0
long get_next_reusable_object_id(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00546030
int initializePathingSystem(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00546070
uchar recycle_object_out_of_game(RGE_Game_World* this_, uchar param_2, RGE_Static_Object* param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00546180
RGE_Static_Object* recycle_object_in_to_game(RGE_Game_World* this_, uchar param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: class RGE_Static_Object * __thiscall RGE_Game_World::recycle_object_in_to_game(unsigned char) *
    //                              *********************************************************************************************************
...
// Offset: 0x005462D0
void update_mutual_allies(RGE_Game_World* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
