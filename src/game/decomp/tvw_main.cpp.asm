// Auto-generated scaffold unit: tvw_main.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/tvw_main.cpp
...
// Offset: 0x0052D060
int draw_wall_outline(TRIBE_Main_View* this_, long param_2, long param_3, TRIBE_Master_Building_Object* param_4, long param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: int __thiscall TRIBE_Main_View::draw_wall_outline(long,long,class TRIBE_Master_Building... *
    //                              *********************************************************************************************************
...
int TRIBE_Main_View::command_place_multi_object(long param_1, long param_2, long param_3, long param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: virtual int __thiscall TRIBE_Main_View::command_place_multi_object(long,long,long,long,int)   *
    //                              *********************************************************************************************************
...
// Offset: 0x0052D4F0
void place_line_of_walls(TRIBE_Main_View* this_, TRIBE_Player* param_2, TRIBE_Master_Building_Object* param_3, int param_4, int param_5, int param_6, int param_7) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * protected: void __thiscall TRIBE_Main_View::place_line_of_walls(class TRIBE_Player *,class TRIBE_M... *
    //                              *********************************************************************************************************
