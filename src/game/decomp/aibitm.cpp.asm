// Auto-generated scaffold unit: aibitm.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/aibitm.cpp
#include "../include/common.h"

// Offset: 0x00407D80
undefined BaseItem(BaseItem* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407E00
undefined BaseItem(BaseItem* this_, int param_2, int param_3, int param_4, char* param_5, float param_6, float param_7, float param_8, float param_9, float param_10, float param_11) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00407E70
undefined BaseItem(BaseItem* this_, BaseItem* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
int operator(BaseItem* param_1, BaseItem* param_2) {
    ...
    //              int               EAX:4          <RETURN>
    //              BaseItem *        Stack[0x4]:4   param_1                   XREF[1]:     00407f80(R)  
    //              BaseItem *        Stack[0x8]:4   param_2                   XREF[1]:     00407f84(R)  
    //                               ??8@YAHABVBaseItem@@0@Z                                      XREF[1]:     operator!=:00407fca(c)  
    //                               operator==
    //                              aibitm.cpp:95 (45)
    //         00407f80     MOV        ECX,dword ptr [ESP + param_1]
    //         00407f84     MOV        EDX,dword ptr [ESP + param_2]
    //         00407f88     PUSH       ESI
    //         00407f89     MOV        EAX,dword ptr [ECX + 0x8]
    //         00407f8c     MOV        ESI,dword ptr [EDX + 0x8]
    //         00407f8f     CMP        EAX,ESI
    //         00407f91     JNZ        LAB_00407fb4
    //         00407f93     FLD        float ptr [ECX + 0x50]
    //         00407f96     FCOMP      float ptr [EDX + 0x50]
    //         00407f99     FNSTSW     AX
    //         00407f9b     TEST       AH,0x40
    //         00407f9e     JZ         LAB_00407fb4
    //         00407fa0     FLD        float ptr [ECX + 0x54]
    //         00407fa3     FCOMP      float ptr [EDX + 0x54]
    //         00407fa6     FNSTSW     AX
    //         00407fa8     TEST       AH,0x40
    //         00407fab     JZ         LAB_00407fb4
    //                              aibitm.cpp:99 (5)
    //         00407fad     MOV        EAX,0x1
    //                              aibitm.cpp:101 (2)
    //         00407fb2     POP        ESI
    //         00407fb3     RET
    //                               LAB_00407fb4                                                 XREF[3]:     00407f91(j), 00407f9e(j), 
    //                                                                                                         00407fab(j)  
    //                              aibitm.cpp:100 (2)
    //         00407fb4     XOR        EAX,EAX
    //                              aibitm.cpp:101 (2)
    //         00407fb6     POP        ESI
    //         00407fb7     RET
}
...
int operator(BaseItem* param_1, BaseItem* param_2) {
    ...
    //                              int __cdecl operator!=(BaseItem * param_1, BaseItem * param_2)
    //              int               EAX:4          <RETURN>
    //              BaseItem *        Stack[0x4]:4   param_1                   XREF[1]:     00407fc4(R)  
    //              BaseItem *        Stack[0x8]:4   param_2                   XREF[1]:     00407fc0(R)  
    //                               ??9@YAHABVBaseItem@@0@Z
    //                               operator!=
    //                              aibitm.cpp:106 (23)
    //         00407fc0     MOV        EAX,dword ptr [ESP + param_2]
    //         00407fc4     MOV        ECX,dword ptr [ESP + param_1]
    //         00407fc8     PUSH       EAX
    //         00407fc9     PUSH       ECX
    //         00407fca     CALL       operator==                                       int operator==(BaseItem * param_1, BaseItem *
    //         00407fcf     ADD        ESP,0x8
    //         00407fd2     NEG        EAX
    //         00407fd4     SBB        EAX,EAX
    //         00407fd6     INC        EAX
    //                              aibitm.cpp:108 (1)
    //         00407fd7     RET
}
...
int operator(BaseItem* param_1, BaseItem* param_2) {
    ...
    //                              int __cdecl operator<(BaseItem * param_1, BaseItem * param_2)
    //              int               EAX:4          <RETURN>
    //              BaseItem *        Stack[0x4]:4   param_1                   XREF[1]:     00407fe0(R)  
    //              BaseItem *        Stack[0x8]:4   param_2                   XREF[1]:     00407fe4(R)  
    //                               ??M@YAHABVBaseItem@@0@Z
    //                               operator<
    //                              aibitm.cpp:113 (22)
    //         00407fe0     MOV        EAX,dword ptr [ESP + param_1]
    //         00407fe4     MOV        EDX,dword ptr [ESP + param_2]
    //         00407fe8     PUSH       ESI
    //         00407fe9     MOV        ECX,dword ptr [EAX + 0x8]
    //         00407fec     MOV        ESI,dword ptr [EDX + 0x8]
    //         00407fef     XOR        EAX,EAX
    //         00407ff1     CMP        ECX,ESI
    //         00407ff3     SETL       AL
    //                              aibitm.cpp:117 (2)
    //         00407ff6     POP        ESI
    //         00407ff7     RET
...
int operator(BaseItem* param_1, BaseItem* param_2) {
    ...
    //                              int __cdecl operator>(BaseItem * param_1, BaseItem * param_2)
    //              int               EAX:4          <RETURN>
    //              BaseItem *        Stack[0x4]:4   param_1                   XREF[1]:     00408000(R)  
    //              BaseItem *        Stack[0x8]:4   param_2                   XREF[1]:     00408004(R)  
    //                               ??O@YAHABVBaseItem@@0@Z
    //                               operator>
    //                              aibitm.cpp:122 (22)
    //         00408000     MOV        EAX,dword ptr [ESP + param_1]
    //         00408004     MOV        EDX,dword ptr [ESP + param_2]
    //         00408008     PUSH       ESI
    //         00408009     MOV        ECX,dword ptr [EAX + 0x8]
    //         0040800c     MOV        ESI,dword ptr [EDX + 0x8]
    //         0040800f     XOR        EAX,EAX
    //         00408011     CMP        ECX,ESI
    //         00408013     SETG       AL
    //                              aibitm.cpp:126 (2)
    //         00408016     POP        ESI
    //         00408017     RET
...
// Offset: 0x004080D0
void setTypeID(BaseItem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004080E0
void setGameID(BaseItem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x004080F0
void setUniqueID(BaseItem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408100
void setName(BaseItem* this_, char* param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408120
void setX(BaseItem* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408130
void setY(BaseItem* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408140
void setZ(BaseItem* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408150
void setXSize(BaseItem* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408160
void setYSize(BaseItem* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408170
void setZSize(BaseItem* this_, float param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x00408180
void setSkip(BaseItem* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
