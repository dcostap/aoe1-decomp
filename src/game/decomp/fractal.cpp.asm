// Auto-generated scaffold unit: fractal.cpp.asm
// SourceMap: C:/msdev/work/age1_x1/fractal.cpp
#include "../include/common.h"

// Offset: 0x0044AB90
void SetDefaultValues(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044AC50
undefined PointMaker(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044AC80
void PointMaker(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
    //                              * public: __thiscall PointMaker::~PointMaker(void)                                                      *
    //                              *********************************************************************************************************
...
// Offset: 0x0044ACB0
void CreateMasks(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044AF90
void DeleteMasks(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044AFE0
void DrawMask(PointMaker* this_, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B210
void ClearArrays(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B270
void DeleteArrays(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B2B0
void MakeArrays(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B320
int CreateShape(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B470
int CreateShape(PointMaker* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B540
void Branch(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B610
int MakeFirstLink(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B760
int MakeNewLink(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044B950
int MakeSatelliteLink(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044BAA0
void DrawPrimaryIntoProbabilityArray(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044BB60
void DrawCurrentBranchIntoProbArray(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044BCD0
void DrawCurrentSatelliteIntoProbArray(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044BD80
void AddingRect(PointMaker* this_, int param_2, int param_3, int param_4, int param_5) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044BF90
void AddingCircle(PointMaker* this_, int param_2, int param_3, int param_4) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C1B0
void CreateMapBasedOnProbabilityArray(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C200
void SetPoint(PointMaker* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C220
void SetMaxNumberOfBranches(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C230
void SetChanceOfNextNode(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C240
void SetNumberOfSatellites(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C250
void SetSplitsPerBranch(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C260
void SetWidthAndHeight(PointMaker* this_, int param_2, int param_3) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C280
void SetStartPositionRadius(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C290
void SetBranchsRadius(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C2A0
void SetSatelliteRadius(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C2B0
void SetMaxNumberOfBranchLevels(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C2D0
void SetSatelliteDistance(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C2E0
void SetBranchDistance(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C2F0
void SetMinimumNumberOfTiles(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C300
void SetDrawToOneArray(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C310
void SetBorderDepthPercentage(PointMaker* this_, int param_2) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C350
char* RetrieveMap(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C360
char* RetrieveProbMap(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C370
void ErrorCheckingAndCorrection(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C4B0
void PrepareLimits(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
...
// Offset: 0x0044C510
void MapCleanUpEliminatingSinglesOnly(PointMaker* this_) {
    // --- Ghidra listing dump ---
    //                              *********************************************************************************************************
