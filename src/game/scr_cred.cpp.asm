...
TScrollTextPanel::TScrollTextPanel(TPanel* param_1, TDrawArea* param_2, long param_3, long param_4, long param_5, long param_6, int param_7, void* param_8, long param_9, long param_10, char* param_11) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
}

void TScrollTextPanel::draw_scrolled_line(void* param_1, short param_2, short param_3, ulong param_4, ulong param_5) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
    return;
}
