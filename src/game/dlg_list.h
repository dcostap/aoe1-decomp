...
public:
    ...
    virtual  ~TListDialog() noexcept(false); // Ghidra: `vector_deleting_destructor'
    ...
    virtual short get_list_id(); // Ghidra: get_list_id

    // [Slot 77] Offset 0x134 (Override)
    virtual char* get_list_name(); // Ghidra: get_list_name
