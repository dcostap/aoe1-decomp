...
RGE_RMM_Terrain_Generator::RGE_RMM_Terrain_Generator(RGE_Map* param_1, RGE_Random_Map_Module* param_2, RGE_Terrain_Info* param_3) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
}

uchar RGE_RMM_Terrain_Generator::check_terrain(uchar param_1, long param_2, long param_3, long param_4, uchar param_5) {
    /* TODO: Stub */
    // <NO ASSEMBLY FOUND>
    return 0;
}
