...
public:
    ...
    virtual  ~TRIBE_Combat_Object() noexcept(false); // Ghidra: `vector_deleting_destructor'
    ...
    virtual void get_pierce_armor(short* param_1, short* param_2); // Ghidra: get_pierce_armor

    // [Slot 146] Offset 0x248 (Override)
    virtual int higher_check_for_cliff(RGE_Static_Object* param_1, int param_2, int param_3, float param_4, float param_5, float param_6, float param_7, RGE_Map* param_8, RGE_Static_Object* param_9, float* param_10, int* param_11); // Ghidra: higher_check_for_cliff

    // [Slot 147] Offset 0x24C (Override)
    virtual int higher_than_target(RGE_Static_Object* param_1); // Ghidra: higher_than_target

    // [Slot 148] Offset 0x250 (Override)
    virtual void initUnitAI(); // Ghidra: initUnitAI

    // [Slot 149] Offset 0x254 (Override)
    virtual int setup(TRIBE_Master_Combat_Object* param_1, RGE_Player* param_2, float param_3, float param_4, float param_5); // Ghidra: setup
